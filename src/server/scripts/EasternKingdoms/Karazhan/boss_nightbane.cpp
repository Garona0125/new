...
public:
    ...
    struct boss_nightbaneAI : public QuantumBasicAI
    {
        boss_nightbaneAI(Creature* creature) : QuantumBasicAI(creature)
        {
        ...
        void MovementInform(uint32 type, uint32 id)
        {
            ...
            if (id == 7)
            {
                ...
                me->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_SELECTABLE | UNIT_FLAG_NO_AGGRO_FOR_PLAYER | UNIT_FLAG_UNK_6);
