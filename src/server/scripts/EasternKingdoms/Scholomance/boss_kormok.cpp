...
public:
    ...
    struct boss_kormokAI : public QuantumBasicAI
    {
        boss_kormokAI(Creature* creature) : QuantumBasicAI(creature)
        {
            Initialize();
        }
        ...
        {
            if (me->HealthBelowPctDamaged(HEALTH_PERCENT_25, damage) && !Mages)
            {
