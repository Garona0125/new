...
public:
    ...
    struct npc_ragged_johnAI : public QuantumBasicAI
    {
        npc_ragged_johnAI(Creature* creature) : QuantumBasicAI(creature) {}
        ...
        void MoveInLineOfSight(Unit* who)
        {
            ...
            {
                if (who->GetTypeId() == TYPE_ID_PLAYER && me->IsWithinDistInMap(who, 15) && who->IsInAccessiblePlaceFor(me))
                {
