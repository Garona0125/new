...
public:
    ...
    struct boss_interrogator_vishasAI : public QuantumBasicAI
    {
        boss_interrogator_vishasAI(Creature* creature) : QuantumBasicAI(creature)
        {
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            if (ShadowWordPainTimer <= diff)
            {
                ...
                ShadowWordPainTimer = urand(5000, 15000);
            }
