...
#ifndef ICECROWN_CITADEL_H
#define ICECROWN_CITADEL_H
...
enum SharedSpells
{
	...
	// Teleport Spells
	SPELL_LIGHTS_HAMMER_TELEPORT         = 70781,
    SPELL_ORATORY_OF_THE_DAMNED_TELEPORT = 70856,
    SPELL_RAMPART_OF_SKULLS_TELEPORT     = 70857,
    SPELL_DEATHBRINGERS_RISE_TELEPORT    = 70858,
    SPELL_UPPER_SPIRE_TELEPORT           = 70859,
    SPELL_FROZEN_THRONE_TELEPORT         = 70860,
    SPELL_SINDRAGOSAS_LAIR_TELEPORT      = 70861,
};

enum Achievements
{
	ACHIEVEMENT_IM_ON_A_BOAT_10          = 4536,
	ACHIEVEMENT_IM_ON_A_BOAT_25          = 4612,
	ACHIEVEMENT_STORMING_THE_CITADEL_10N = 4531,
	ACHIEVEMENT_STORMING_THE_CITADEL_25N = 4604,
	ACHIEVEMENT_STORMING_THE_CITADEL_10H = 4628,
	ACHIEVEMENT_STORMING_THE_CITADEL_25H = 4632,
...
enum DataTypes
{
    ...
    DATA_CROK_SCOURGEBANE_PART_1    = 31,
	DATA_CROK_SCOURGEBANE_PART_2    = 32,
    DATA_CAPTAIN_ARNATH             = 33,
    DATA_CAPTAIN_BRANDON            = 34,
    DATA_CAPTAIN_GRONDEL            = 35,
    DATA_CAPTAIN_RUPERT             = 36,
    DATA_VALITHRIA_TRIGGER          = 37,
	DATA_VALITHRIA_QUEST            = 38,
    DATA_VALITHRIA_LICH_KING        = 39,
    DATA_HIGHLORD_TIRION_FORDRING   = 40,
    DATA_ARTHAS_PLATFORM            = 41,
    DATA_TERENAS_MENETHIL           = 42,
	// Gunship
	DATA_BEEN_WAITING_ACHIEVEMENT   = 43,
	DATA_NECK_DEEP_ACHIEVEMENT      = 44,
	DATA_WORLD_TRIGGER              = 45,
...
enum CreaturesIds
{
	...
	NPC_CROK_SCOURGEBANE_PART_1                 = 35961,
    NPC_CROK_SCOURGEBANE_PART_2                 = 37129,
	...
	NPC_WORLD_TRIGGER_CACHE                     = 22517,
    NPC_WORLD_TRIGGER_INFINITE_AOI              = 36171,
    NPC_SPIRIT_BOMB                             = 39189,
    NPC_FROSTMOURNE_TRIGGER                     = 38584,
	NPC_ALEXANDROS_MOGRAINE                     = 38610,
	NPC_UTHER_THE_LIGHTBRINGER                  = 38608,
	// Generic
	...
	NPC_SKYBREAKER_BATTLE_STANDARD              = 37041,
	NPC_KORKRON_BATTLE_STANDARD                 = 37044,
	NPC_EMPOWERED_VAMPIRIC_FIEND                = 37919,
	...
	NPC_GB_HIGH_OVERLORD_SAURFANG_NOT_VISUAL    = 38311,
	NPC_GB_MURADIN_BRONZEBEARD_NOT_VISUAL       = 38313,
	NPC_GB_SKYBREAKER_VINDICATOR                = 37003,
	NPC_GB_SKYBREAKER_SORCERER                  = 37026,
	NPC_GB_SKYBREAKER_SORCERERS                 = 37116,
	NPC_GB_SKYBREAKER_PROTECTOR                 = 36998,
	NPC_GB_KORKRON_PRIMALIST                    = 37030,
	NPC_GB_KORKRON_ORACLE                       = 37031,
	NPC_GB_KORKRON_INVOKER                      = 37033,
	NPC_GB_KORKRON_DEFENDER                     = 37032,
...
enum GameObjectsIds
{
	...
	GO_SCOURGE_TRANSPORTER_LK_FINAL         = 202247,
...
enum Misc
{
	...
	AREA_ICECROWN_CITADEL   = 4522,

	SOUND_ID_GUNSHIP_BATTLE = 17289,

	ITEM_THE_ROCKET_PACK    = 49278,
	ITEM_THE_SHADOW_S_EDGE  = 49888,
};
