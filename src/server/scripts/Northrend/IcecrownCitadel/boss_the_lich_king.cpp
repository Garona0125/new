...
enum Texts
{
    SAY_LK_INTRO_1                  = -1659179,
    SAY_LK_INTRO_2                  = -1659180,
    SAY_LK_INTRO_3                  = -1659181,
	SAY_LK_AGGRO                    = -1659182,
    SAY_LK_REMORSELESS_WINTER       = -1659183,
    SAY_LK_QUAKE                    = -1659184,
    SAY_LK_SUMMON_VALKYR            = -1659185,
    SAY_LK_HARVEST_SOUL             = -1659186,
    SAY_LK_FROSTMOURNE_ESCAPE       = -1659187,
    SAY_LK_FROSTMOURNE_KILL         = -1659188,
    SAY_LK_KILL_1                   = -1659189,
	SAY_LK_KILL_2                   = -1659190,
    SAY_LK_BERSERK                  = -1659191,
    EMOTE_DEFILE_WARNING            = -1659192,
    EMOTE_NECROTIC_PLAGUE_WARNING   = -1659193,
    SAY_LK_OUTRO_1                  = -1659194,
    SAY_LK_OUTRO_2                  = -1659195,
    SAY_LK_OUTRO_3                  = -1659196,
    SAY_LK_OUTRO_4                  = -1659197,
    SAY_LK_OUTRO_5                  = -1659198,
    SAY_LK_OUTRO_6                  = -1659199,
    SAY_LK_OUTRO_7                  = -1659200,
    SAY_LK_OUTRO_8                  = -1659201,
	SAY_LK_RANDOM_1                 = -1659202,
	SAY_LK_RANDOM_2                 = -1659203,
	SAY_LK_FURY_OF_FROSTMOURNE      = -1659204,
    SAY_TIRION_INTRO_1              = -1659205,
    SAY_TIRION_INTRO_2              = -1659206,
    SAY_TIRION_OUTRO_1              = -1659207,
    SAY_TIRION_OUTRO_2              = -1659208,
	SAY_TIRION_OUTRO_3              = -1659209,
    SAY_TERENAS_OUTRO_1             = -1659210,
    SAY_TERENAS_OUTRO_2             = -1659211,
    SAY_TERENAS_INTRO_1             = -1659212,
    SAY_TERENAS_INTRO_2             = -1659213,
    SAY_TERENAS_INTRO_3             = -1659214,
};
...
enum Spells
{
    ...
    SPELL_SOUL_SHRIEK_10N               = 69242,
	SPELL_SOUL_SHRIEK_25N               = 73800,
	SPELL_SOUL_SHRIEK_10H               = 73801,
	SPELL_SOUL_SHRIEK_25H               = 73802,
    SPELL_QUAKE                         = 72262,
    // Phase 2
    SPELL_DEFILE                        = 72762,
    ...
    SPELL_LIFE_SIPHON_10N               = 73488,
	SPELL_LIFE_SIPHON_25N               = 73782,
	SPELL_LIFE_SIPHON_10H               = 73783,
	SPELL_LIFE_SIPHON_25H               = 73784,
	...
	SPELL_HARVEST_SOUL_10H              = 74326,
	SPELL_HARVEST_SOUL_25H              = 74327,
    SPELL_HARVEST_SOULS_10N             = 73654,
	SPELL_HARVEST_SOULS_25N             = 74295,
	...
	SPELL_SPIRIT_SPAWN_VISUAL           = 72469,
    ...
    SPELL_EXPLOSION_10N                 = 73576,    // Spirit Bomb (Heroic)
	SPELL_EXPLOSION_25N                 = 73803,
	SPELL_EXPLOSION_10H                 = 73804,
	SPELL_EXPLOSION_25H                 = 73805,
	...
	SPELL_DEATH_EFFECT_VISUAL           = 54262,
    // Shambling Horror
    SPELL_SHOCKWAVE_10N                 = 72149,
	SPELL_SHOCKWAVE_25N                 = 73794,
	SPELL_SHOCKWAVE_10H                 = 73795,
	SPELL_SHOCKWAVE_25H                 = 73796,
    SPELL_ENRAGE_10N                    = 72143,
	SPELL_ENRAGE_25N                    = 72146,
	SPELL_ENRAGE_10H                    = 72147,
	SPELL_ENRAGE_25H                    = 72148,
    SPELL_FRENZY                        = 28747,
	// Buffs
	SPELL_STRENGHT_OF_WRYNN_1           = 73824,
	SPELL_STRENGHT_OF_WRYNN_2           = 73762,
	SPELL_HELLSCREAM_WARSONG_1          = 73818,
	SPELL_HELLSCREAM_WARSONG_2          = 73816,
};
...
enum Events
{
	...
	EVENT_CHECK_PLAYER_POSITIONS    = 64,
	EVENT_SPEECH                    = 65,
};
...
Position const MograineSpawn      = {515.209f, -2127.47f, 840.858f, 3.14324f};
Position const UtherSpawn         = {514.302f, -2121.17f, 840.858f, 3.52023f};
...
{
    public:
        NecroticPlagueTargetCheck(Unit const* obj, uint32 notAura1 = 0, uint32 notAura2 = 0) : _sourceObj(obj), _notAura1(notAura1), _notAura2(notAura2){}

        bool operator()(Unit* unit) const
        {
			if (!unit || unit == _sourceObj || !unit->IsTargetableForAttack() || unit->GetTypeId() != TYPE_ID_PLAYER || unit->HasAura(SPELL_PLAGUE_AVOIDANCE))
                return false;
...
class StartMovementEvent : public BasicEvent
{
    public:
        ...
        bool Execute(uint64 /*time*/, uint32 /*diff*/)
        {
            ...
            if (Unit* target = _summoner->AI()->SelectTarget(TARGET_RANDOM, 0, NonTankTargetSelector(_summoner)))
...
class boss_the_lich_king : public CreatureScript
{
    public:
        ...
        struct boss_the_lich_kingAI : public BossAI
        {
			...
			uint32 NecroticPlagueStack;
            uint32 VileSpiritExplosions;
            ...
            void Reset()
            {
				...
				DoCast(me, SPELL_EMOTE_SIT_NO_SHEATH, true);

				// Teleporter flag
				if (GameObject* transporter = GameObject::GetGameObject(*me, instance->GetData64(GO_SCOURGE_TRANSPORTER_LK_FINAL)))
				{
					instance->HandleGameObject(0, true, transporter);
					transporter->RemoveFlag(GAMEOBJECT_FLAGS, GO_FLAG_IN_USE);
				}
            }
			...
			void EnterToBattle(Unit* who)
            {
				...
				DoSendQuantumText(SAY_LK_AGGRO, me);

                events.SetPhase(PHASE_ONE);
				events.ScheduleEvent(EVENT_SPEECH, 40000);
            ...
            {
				if (victim->GetTypeId() == TYPE_ID_PLAYER && !me->IsInEvadeMode() && !events.IsInPhase(PHASE_OUTRO))
					DoSendQuantumText(RAND(SAY_LK_KILL_1, SAY_LK_KILL_2), me);
            }
			...
			void JustDied(Unit* killer)
            {
                ...
                if (Creature* frostmourne = me->FindCreatureWithDistance(NPC_FROSTMOURNE_TRIGGER, 150.0f))
                    frostmourne->DespawnAfterAction();
			...
			void HolyChampion()
			{
				...
				for (Map::PlayerList::const_iterator itr = Players.begin(); itr != Players.end(); ++itr)
				{
					if (!Players.isEmpty())
					{
						...
						{
							if (me->IsWithinDist(player, 350.0f))
								player->CastSpell(player, SPELL_HOLY_CHAMPION, true);
						}
					}
				}
			}
			...
			void SetImmuneToTaunt(bool apply)
			{
				...
				me->ApplySpellImmune(0, IMMUNITY_AURA_TYPE, SPELL_AURA_MOD_TAUNT, apply);
				// Following might not be necessay, but just in case...
				me->ApplySpellImmune(0, IMMUNITY_AURA_TYPE, SPELL_AURA_MOD_TOTAL_THREAT, apply);
				me->ApplySpellImmune(0, IMMUNITY_AURA_TYPE, SPELL_AURA_MOD_CRITICAL_THREAT, apply);
			...
			void HandleAuraBuffOnAllPlayers()
            {
                ...
                for (Map::PlayerList::const_iterator itr = PlayerList.begin(); itr != PlayerList.end(); ++itr)
                {
                    if (itr->getSource())
                    {
                         if (itr->getSource()->GetTeamId() == TEAM_ALLIANCE)
                         {
                             // Remove old aura
                             if (itr->getSource()->HasAura(SPELL_STRENGHT_OF_WRYNN_1))
                                 itr->getSource()->RemoveAurasDueToSpell(SPELL_STRENGHT_OF_WRYNN_1);

                             // Add new aura
                             if (itr->getSource()->IsAlive() && !itr->getSource()->HasAura(SPELL_STRENGHT_OF_WRYNN_2))
                                 itr->getSource()->CastSpell(itr->getSource(), SPELL_STRENGHT_OF_WRYNN_2, true);
                         }
                         else
                         {
                             // Remove old aura
                             if (itr->getSource()->HasAura(SPELL_HELLSCREAM_WARSONG_1))
                                 itr->getSource()->RemoveAurasDueToSpell(SPELL_HELLSCREAM_WARSONG_1);

                             // Add new aura
                             if (itr->getSource()->IsAlive() && !itr->getSource()->HasAura(SPELL_HELLSCREAM_WARSONG_2))
                                 itr->getSource()->CastSpell(itr->getSource(), SPELL_HELLSCREAM_WARSONG_2, true);
						 }
					}
                }
            }
            ...
            void DoAction(int32 const action)
            {
                switch (action)
                {
                    case ACTION_START_ENCOUNTER:
						...
						if (GameObject* transporter = GameObject::GetGameObject(*me, instance->GetData64(GO_SCOURGE_TRANSPORTER_LK_FINAL)))
						{
							instance->HandleGameObject(0, false, transporter);
							transporter->SetFlag(GAMEOBJECT_FLAGS, GO_FLAG_IN_USE);
						}
                        instance->SetBossState(DATA_THE_LICH_KING, IN_PROGRESS);
                        DoSendQuantumText(SAY_LK_INTRO_1, me);
                    ...
                    case ACTION_TELEPORT_BACK:
                    {
                        ...
                        summons.DoAction(ACTION_TELEPORT_BACK, pred);
                        if (!IsHeroic())
                            DoSendQuantumText(SAY_LK_FROSTMOURNE_ESCAPE, me);
                        break;
                    }
                    default:
                        break;
            ...
            uint32 GetData(uint32 type)
            {
                switch (type)
                {
                    case DATA_PLAGUE_STACK:
                        return NecroticPlagueStack;
                    case DATA_VILE:
                        return VileSpiritExplosions;
                    default:
                        break;
                }
            ...
            void SetData(uint32 type, uint32 value)
            {
                ...
                {
                    case DATA_PLAGUE_STACK:
                        NecroticPlagueStack = std::max(value, NecroticPlagueStack);
                        break;
                    case DATA_VILE:
                        VileSpiritExplosions += value;
                        break;
                    default:
                        break;
                }
            ...
            {
				if (events.IsInPhase(PHASE_ONE) && !HealthAbovePct(HEALTH_PERCENT_70))
                {
				...
				if (events.IsInPhase(PHASE_TWO) && !HealthAbovePct(HEALTH_PERCENT_40))
                {
					SetImmuneToTaunt(true);
                    events.SetPhase(PHASE_TRANSITION);
                    me->SetReactState(REACT_PASSIVE);
				...
				if (events.IsInPhase(PHASE_THREE) && !HealthAbovePct(HEALTH_PERCENT_10))
                {
                    me->SetReactState(REACT_PASSIVE);
                    me->AttackStop();
                    events.Reset();
					...
					DoSendQuantumText(SAY_LK_FURY_OF_FROSTMOURNE, me);
                    me->CastSpell((Unit*)NULL, SPELL_FURY_OF_FROSTMOURNE, TRIGGERED_NONE);
                    me->SetWalk(true);
					events.ScheduleEvent(EVENT_OUTRO_TALK_1, 14600, 0, PHASE_OUTRO);
                    ...
                    events.ScheduleEvent(EVENT_OUTRO_TALK_2, 39600, 0, PHASE_OUTRO);
                    events.ScheduleEvent(EVENT_OUTRO_TALK_3, 48600, 0, PHASE_OUTRO);
            ...
            void SummonedCreatureDies(Creature* summon, Unit* /*killer*/)
            {
                switch (summon->GetEntry())
                {
                    ...
                    case NPC_VILE_SPIRIT:
                        summon->ToTempSummon()->SetTempSummonType(TEMPSUMMON_CORPSE_TIMED_DESPAWN);
                        break;
                    default:
                        break;
                }
            ...
            {
                if (spell->Id == SPELL_HARVESTED_SOUL && me->IsInCombatActive() && !IsHeroic())
                    DoSendQuantumText(SAY_LK_FROSTMOURNE_KILL, me);
            }
            ...
            void MovementInform(uint32 type, uint32 pointId)
            {
                ...
                switch (pointId)
                {
                    ...
                    case POINT_CENTER_1:
                        ...
                        me->SetFacingTo(0.0f);
                        DoSendQuantumText(SAY_LK_REMORSELESS_WINTER, me);
                    ...
                    case POINT_LK_OUTRO_2:
                        if (Creature* tirion = ObjectAccessor::GetCreature(*me, instance->GetData64(DATA_HIGHLORD_TIRION_FORDRING)))
							DoSendQuantumText(SAY_TIRION_OUTRO_2, tirion);
                        if (Creature* frostmourne = me->FindCreatureWithDistance(NPC_FROSTMOURNE_TRIGGER, 50.0f))
            ...
            void UpdateAI(uint32 const diff)
            {
				...
				if (me->GetDistance2d(me->GetHomePosition().GetPositionX(), me->GetHomePosition().GetPositionY()) > 142)
				{
					EnterEvadeMode(); // Resetting threats when falling character off the platform.
					return;
				}
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_INTRO_TALK_1:
                            DoSendQuantumText(SAY_LK_INTRO_2, me);
                        ...
                        case EVENT_INTRO_CAST_FREEZE:
                            DoSendQuantumText(SAY_LK_INTRO_3, me);
                        ...
                        case EVENT_FINISH_INTRO:
                            ...
                            break;
						case EVENT_SPEECH:
							DoSendQuantumText(RAND(SAY_LK_RANDOM_1, SAY_LK_RANDOM_2), me);
							events.ScheduleEvent(EVENT_SPEECH, 40000);
							break;
                        ...
                        case EVENT_SUMMON_DRUDGE_GHOUL:
                            ...
                            break;
                        case EVENT_INFEST:
                            DoCast(me, RAID_MODE(SPELL_INFEST_10N, SPELL_INFEST_25N, SPELL_INFEST_10H, SPELL_INFEST_25H));
                            events.ScheduleEvent(EVENT_INFEST, urand(21000, 24000), 0, events.IsInPhase(PHASE_ONE) ? PHASE_ONE : PHASE_TWO);
                            break;
                        case EVENT_NECROTIC_PLAGUE:
                            if (Unit* target = SelectTarget(TARGET_RANDOM, 1, NecroticPlagueTargetCheck(me, NECROTIC_PLAGUE_LK, NECROTIC_PLAGUE_PLR)))
                            {
                                DoSendQuantumText(EMOTE_NECROTIC_PLAGUE_WARNING, target);
                        ...
                        case EVENT_SOUL_REAPER:
                            ...
                            break;
                        case EVENT_DEFILE:
                            if (Unit* target = SelectTarget(TARGET_RANDOM, 1, 0.0f, true, -SPELL_HARVEST_SOUL_VALKYR))
                            {
                                DoSendQuantumText(EMOTE_DEFILE_WARNING, me);
                                DoCast(target, SPELL_DEFILE);
                            }
                            events.ScheduleEvent(EVENT_DEFILE, urand(32000, 35000), 0, PHASE_TWO_THREE);
                            break;
                        case EVENT_HARVEST_SOUL:
                            DoSendQuantumText(SAY_LK_HARVEST_SOUL, me);
                            if (Unit* target = SelectTarget(TARGET_RANDOM, 0, SpellTargetSelector(me, HARVEST_SOUL)))
                                DoCast(target, RAID_MODE(SPELL_HARVEST_SOUL_10N, SPELL_HARVEST_SOUL_25N, SPELL_HARVEST_SOUL_10H, SPELL_HARVEST_SOUL_25H));
                        ...
                        case EVENT_QUAKE:
							...
							me->GetMap()->SetZoneMusic(AREA_THE_FROZEN_THRONE, MUSIC_SPECIAL);
                            DoSendQuantumText(SAY_LK_QUAKE, me);
                            break;
                        case EVENT_QUAKE_2:
                        ...
                        case EVENT_SUMMON_VALKYR:
							me->GetMap()->SetZoneMusic(AREA_THE_FROZEN_THRONE, MUSIC_FINAL);
                            DoSendQuantumText(SAY_LK_SUMMON_VALKYR, me);
                        ...
                        case EVENT_HARVEST_SOULS:
                            DoSendQuantumText(SAY_LK_HARVEST_SOUL, me);
                            DoCastAOE(RAID_MODE(SPELL_HARVEST_SOULS_10N, SPELL_HARVEST_SOULS_25N, SPELL_HARVEST_SOULS_10H, SPELL_HARVEST_SOULS_25H));
                        ...
                        case EVENT_OUTRO_TALK_1:
                            DoSendQuantumText(SAY_LK_OUTRO_1, me);
                            DoCastAOE(SPELL_FURY_OF_FROSTMOURNE_NO_REZ, true);
                            break;
                        case EVENT_OUTRO_TALK_2:
                            DoSendQuantumText(SAY_LK_OUTRO_2, me);
                        ...
                        case EVENT_OUTRO_TALK_3:
                            ...
                            DoSendQuantumText(SAY_LK_OUTRO_3, me);
                            break;
                        ...
                        case EVENT_OUTRO_TALK_4:
                            ...
                            DoSendQuantumText(SAY_LK_OUTRO_4, me);
                            break;
                        ...
                        case EVENT_OUTRO_TALK_5:
                            DoSendQuantumText(SAY_LK_OUTRO_5, me);
                            if (Creature* tirion = ObjectAccessor::GetCreature(*me, instance->GetData64(DATA_HIGHLORD_TIRION_FORDRING)))
                                tirion->AI()->DoAction(ACTION_OUTRO);
                            break;
                        case EVENT_OUTRO_TALK_6:
                            DoSendQuantumText(SAY_LK_OUTRO_6, me);
                            if (Creature* tirion = ObjectAccessor::GetCreature(*me, instance->GetData64(DATA_HIGHLORD_TIRION_FORDRING)))
                        ...
                        case EVENT_OUTRO_TALK_7:
                            DoSendQuantumText(SAY_LK_OUTRO_7, me);
                            break;
                        case EVENT_OUTRO_TALK_8:
                            DoSendQuantumText(SAY_LK_OUTRO_8, me);
                            break;
                        case EVENT_BERSERK:
                            DoSendQuantumText(SAY_LK_BERSERK, me);
...
class npc_tirion_fordring_tft : public CreatureScript
{
    public:
        ...
        struct npc_tirion_fordringAI : public QuantumBasicAI
        {
            npc_tirion_fordringAI(Creature* creature) : QuantumBasicAI(creature), instance(creature->GetInstanceScript()){}
            ...
            void MovementInform(uint32 type, uint32 id)
            {
                ...
                switch (id)
                {
                    case POINT_TIRION_INTRO:
                        ...
                        if (Creature* theLichKing = ObjectAccessor::GetCreature(*me, instance->GetData64(DATA_THE_LICH_KING)))
                ...
                while (uint32 eventId = _events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_INTRO_CHARGE:
                            ...
                            break;
                        case EVENT_OUTRO_TALK_1:
                            DoSendQuantumText(SAY_TIRION_OUTRO_1, me);
                            break;
                        ...
                        case EVENT_OUTRO_JUMP:
							...
							me->HandleEmoteCommand(EMOTE_ONESHOT_ATTACK_2H_TIGHT);
...
class npc_shambling_horror_icc : public CreatureScript
{
    public:
        ...
        struct npc_shambling_horror_iccAI : public QuantumBasicAI
        {
            npc_shambling_horror_iccAI(Creature* creature) : QuantumBasicAI(creature)
            {
                _frenzied = false;
            }
            ...
            void DamageTaken(Unit* /*attacker*/, uint32& damage)
            {
                if (!_frenzied && IsHeroic() && me->HealthBelowPctDamaged(HEALTH_PERCENT_20, damage))
                {
                    _frenzied = true;
                ...
                while (uint32 eventId = _events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_SHOCKWAVE:
                            DoCast(me, RAID_MODE(SPELL_SHOCKWAVE_10N, SPELL_SHOCKWAVE_25N, SPELL_SHOCKWAVE_10H, SPELL_SHOCKWAVE_25H));
                            _events.ScheduleEvent(EVENT_SHOCKWAVE, urand(20000, 25000));
                            break;
                        case EVENT_ENRAGE:
                            DoCast(me, RAID_MODE(SPELL_ENRAGE_10N, SPELL_ENRAGE_25N, SPELL_ENRAGE_10H, SPELL_ENRAGE_25H));
...
class npc_raging_spirit : public CreatureScript
{
    public:
        ...
        struct npc_raging_spiritAI : public QuantumBasicAI
        {
            npc_raging_spiritAI(Creature* creature) : QuantumBasicAI(creature), instance(creature->GetInstanceScript()){}
            ...
            void Reset()
            {
                ...
                if (TempSummon* summon = me->ToTempSummon())
				{
                    if (Unit* summoner = summon->GetSummoner())
					{
						...
						summoner->CastSpell(summoner, SPELL_COPY_WEAPON, true);
					}
				}
            }
                ...
                while (uint32 eventId = _events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_SOUL_SHRIEK:
                            DoCastAOE(RAID_MODE(SPELL_SOUL_SHRIEK_10N, SPELL_SOUL_SHRIEK_25N, SPELL_SOUL_SHRIEK_10H, SPELL_SOUL_SHRIEK_25H));
                            _events.ScheduleEvent(EVENT_SOUL_SHRIEK, urand(12000, 15000));
                            break;
                        default:
                            break;
...
class npc_valkyr_shadowguard : public CreatureScript
{
    public:
        ...
        struct npc_valkyr_shadowguardAI : public QuantumBasicAI
        {
            npc_valkyr_shadowguardAI(Creature* creature) : QuantumBasicAI(creature), _instance(creature->GetInstanceScript()){}
            ...
            void DamageTaken(Unit* /*attacker*/, uint32& damage)
            {
                ...
                if (me->HealthBelowPctDamaged(HEALTH_PERCENT_50, damage))
                {
                    _events.Reset();
                    ...
                    switch (eventId)
                    {
                        ...
                        case EVENT_LIFE_SIPHON:
                            if (Unit* target = SelectTarget(TARGET_RANDOM, 1))
                                DoCast(target, RAID_MODE(SPELL_LIFE_SIPHON_10N, SPELL_LIFE_SIPHON_25N, SPELL_LIFE_SIPHON_10H, SPELL_LIFE_SIPHON_25H));
...
class npc_strangulate_vehicle : public CreatureScript
{
    public:
        ...
        struct npc_strangulate_vehicleAI : public QuantumBasicAI
        {
            npc_strangulate_vehicleAI(Creature* creature) : QuantumBasicAI(creature), instance(creature->GetInstanceScript()){}
...
class npc_terenas_menethil : public CreatureScript
{
    public:
        ...
        struct npc_terenas_menethilAI : public QuantumBasicAI
        {
            npc_terenas_menethilAI(Creature* creature) : QuantumBasicAI(creature), instance(creature->GetInstanceScript()){}
            ...
            void DamageTaken(Unit* /*attacker*/, uint32& damage)
            {
                if (damage >= me->GetHealth())
                {
                    ...
                    if (!me->HasAura(SPELL_TERENAS_LOSES_INSIDE) && !IsHeroic())
                    {
                        ...
                        if (Creature* warden = me->FindCreatureWithDistance(NPC_SPIRIT_WARDEN, 20.0f))
                        {
                            warden->CastSpell((Unit*)NULL, SPELL_DESTROY_SOUL, TRIGGERED_NONE);
                            warden->DespawnAfterAction(2*IN_MILLISECONDS);
                        }
                ...
                while (uint32 eventId = _events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_FROSTMOURNE_TALK_1:
                            DoSendQuantumText(SAY_TERENAS_INTRO_1, me);
                            if (IsHeroic())
                                DoCastAOE(SPELL_RESTORE_SOULS);
                            break;
                        case EVENT_FROSTMOURNE_TALK_2:
                            DoSendQuantumText(SAY_TERENAS_INTRO_2, me);
                            break;
                        case EVENT_FROSTMOURNE_TALK_3:
                            DoSendQuantumText(SAY_TERENAS_INTRO_3, me);
                            break;
                        case EVENT_OUTRO_TERENAS_TALK_1:
                            DoSendQuantumText(SAY_TERENAS_OUTRO_1, me);
                            break;
                        case EVENT_OUTRO_TERENAS_TALK_2:
                            DoSendQuantumText(SAY_TERENAS_OUTRO_2, me);
                            DoCastAOE(SPELL_MASS_RESURRECTION);
                            if (Creature* lichKing = ObjectAccessor::GetCreature(*me, instance->GetData64(DATA_THE_LICH_KING)))
                            {
                                lichKing->AI()->DoAction(ACTION_FINISH_OUTRO);
                                lichKing->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NO_AGGRO_FOR_CREATURE);
                                if (Creature* tirion = ObjectAccessor::GetCreature(*me, instance->GetData64(DATA_HIGHLORD_TIRION_FORDRING)))
								{
									tirion->SetFlag(UNIT_FIELD_FLAGS,  UNIT_FLAG_NON_ATTACKABLE);
									tirion->CastSpell(tirion, SPELL_TIRION_ASHBRINGER, true);
                                    tirion->AI()->AttackStart(lichKing);
									DoSendQuantumText(SAY_TIRION_OUTRO_3, tirion);

									// Remove Death Visual Spell From Players
									Map::PlayerList const& Players = me->GetMap()->GetPlayers();
									for (Map::PlayerList::const_iterator itr = Players.begin(); itr != Players.end(); ++itr)
									{
										if (Player* player = itr->getSource())
											player->RemoveAura(SPELL_DEATH_EFFECT_VISUAL);
									}
								}
                            }
                            break;
...
class npc_spirit_warden : public CreatureScript
{
    public:
        ...
        struct npc_spirit_wardenAI : public QuantumBasicAI
        {
            npc_spirit_wardenAI(Creature* creature) : QuantumBasicAI(creature), instance(creature->GetInstanceScript()){}
...
class npc_spirit_bomb : public CreatureScript
{
    public:
        ...
        struct npc_spirit_bombAI : public QuantumBasicAI
        {
            npc_spirit_bombAI(Creature* creature) : QuantumBasicAI(creature){}
            ...
            void MovementInform(uint32 type, uint32 point)
            {
                ...
                me->RemoveAllAuras();
                DoCastAOE(RAID_MODE(SPELL_EXPLOSION_10N, SPELL_EXPLOSION_25N, SPELL_EXPLOSION_10H, SPELL_EXPLOSION_25H));
                ...
                while (uint32 eventId = _events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_OUTRO_SUMMON_TERENAS:
							...
							if (TempSummon* mograine = me->GetMap()->SummonCreature(NPC_ALEXANDROS_MOGRAINE, MograineSpawn, NULL, 7*DAY))
							{
								mograine->SetFloatValue(OBJECT_FIELD_SCALE_X, 1.4f);
								mograine->CastSpell(mograine, SPELL_SPIRIT_SPAWN_VISUAL, true);
							}

							if (TempSummon* uther = me->GetMap()->SummonCreature(NPC_UTHER_THE_LIGHTBRINGER, UtherSpawn, NULL, 7*DAY))
							{
								uther->SetFloatValue(OBJECT_FIELD_SCALE_X, 1.1f);
								uther->RemoveFlag(UNIT_NPC_FLAGS, UNIT_NPC_FLAG_GOSSIP | UNIT_NPC_FLAG_QUEST_GIVER);
								uther->CastSpell(uther, SPELL_SPIRIT_SPAWN_VISUAL, true);
								uther->CastSpell(uther, SPELL_RADIANCE_AURA, true);
							}
                            break;
                        default:
                            break;
...
class spell_the_lich_king_infest : public SpellScriptLoader
{
    public:
        ...
        class spell_the_lich_king_infest_AuraScript : public AuraScript
        {
            ...
            {
                if (GetUnitOwner()->HealthAbovePct(HEALTH_PERCENT_90))
                {
        ...
        class spell_the_lich_king_ice_burst_target_search_SpellScript : public SpellScript
        {
            ...
            void CheckTargetCount(std::list<Unit*>& unitList)
            {
                ...
                if (GetCaster()->GetTypeId() == TYPE_ID_UNIT)
				{
                    ...
                    GetCaster()->ToCreature()->DespawnAfterAction(0.5*IN_MILLISECONDS);
				}
            }
    ...
    public:
        ...
        class spell_the_lich_king_vile_spirit_move_target_search_SpellScript : public SpellScript
        {
            ...
            void SelectTarget(std::list<Unit*>& targets)
            {
                ...
                _target = Quantum::DataPackets::SelectRandomContainerElement(targets);
            }
    ...
    public:
        ...
        class spell_the_lich_king_vile_spirit_damage_target_search_SpellScript : public SpellScript
        {
            ...
            void CheckTargetCount(std::list<Unit*>& targets)
            {
                ...
                GetCaster()->ToCreature()->DespawnAfterAction(3*IN_MILLISECONDS);
...
class spell_the_lich_king_restore_soul : public SpellScriptLoader
{
    public:
        ...
        class spell_the_lich_king_restore_soul_SpellScript : public SpellScript
        {
            ...
            void HandleScript(SpellEffIndex /*effIndex*/)
            {
                if (Creature* lichKing = ObjectAccessor::GetCreature(*GetCaster(), instance->GetData64(DATA_THE_LICH_KING)))
                    lichKing->AI()->DoAction(ACTION_TELEPORT_BACK);
                if (Creature* spawner = GetCaster()->FindCreatureWithDistance(NPC_WORLD_TRIGGER_INFINITE_AOI, 50.0f))
...
class spell_the_lich_king_fury_of_frostmourne : public SpellScriptLoader
{
    public:
        spell_the_lich_king_fury_of_frostmourne() : SpellScriptLoader("spell_the_lich_king_fury_of_frostmourne") { }

        class spell_the_lich_king_fury_of_frostmourne_SpellScript : public SpellScript
        {
            PrepareSpellScript(spell_the_lich_king_fury_of_frostmourne_SpellScript);

			bool Validate(SpellInfo const* /*spell*/)
            {
                if (!sSpellMgr->GetSpellInfo(SPELL_FURY_OF_FROSTMOURNE))
                    return false;
                return true;
            }
            ...
            void HandleScript(SpellEffIndex effIndex)
            {
                ...
                if (Player* player = GetHitPlayer())
				{
					player->AddAura(SPELL_DEATH_EFFECT_VISUAL, player);
					player->Kill(player);
				}
            }
            ...
            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_the_lich_king_fury_of_frostmourne_SpellScript::HandleScript, EFFECT_1, SPELL_EFFECT_SCHOOL_DAMAGE);
            }
        };

        SpellScript* GetSpellScript() const
        {
            return new spell_the_lich_king_fury_of_frostmourne_SpellScript();
        }
};
...
void AddSC_boss_the_lich_king()
{
	...
	new spell_the_lich_king_fury_of_frostmourne();
