...
enum Types
{
	...
	DATA_TRIBUTE_TO_DEDICATEDINSANITY_ELIGIBLE = 303,
	...
	DISPLAY_ID_DESTROYED_FLOOR     = 9060,
};
...
const Position DarkBulletsLoc[] =
{
	{620.465f, 134.66f,  395.233f, 4.60767f}, // 1
	{573.578f, 187.665f, 395.492f, 4.60767f}, // 2
	{560.484f, 187.743f, 395.959f, 2.93215f}, // 3
	{619.771f, 143.71f,  395.244f, 4.60767f}, // 4
	{515.352f, 115.349f, 395.288f, 4.60767f}, // 5
	{605.514f, 103.863f, 395.29f,  4.60767f}, // 6
	{615.137f, 156.997f, 395.28f,  4.60767f}, // 7
	{539.179f, 184.132f, 395.282f, 4.60767f}, // 8
	{547.76f,  184.634f, 395.289f, 2.93215f}, // 9
	{549.764f, 86.4444f, 395.266f, 4.60767f}, // 10
	{511.417f, 127.158f, 395.266f, 4.60767f}, // 11
	{597.38f,  183.672f, 395.28f,  4.60767f}, // 12
	{577.299f, 186.854f, 395.289f, 4.60767f}, // 13
	{563.467f, 81.9323f, 395.288f, 4.60767f}, // 14
	{534.748f, 92.6424f, 395.289f, 4.60767f}, // 15
	{518.503f, 170.649f, 395.289f, 4.60767f}, // 16
	{514.566f, 159.918f, 395.287f, 4.60767f}, // 17
	{568.049f, 187.67f,  395.563f, 4.60767f}, // 18
	{522.955f, 102.127f, 395.29f,  4.60767f}, // 19
	{611.656f, 114.281f, 395.288f, 4.60767f}, // 20
	{616.432f, 126.418f, 395.264f, 4.60767f}, // 21
	{526.833f, 181.783f, 395.285f, 4.60767f}, // 22
	{578.722f, 87.4444f, 395.272f, 4.60767f}, // 23
	{509.743f, 149.005f, 395.253f, 4.60767f}, // 24
	{592.736f, 93.6667f, 395.289f, 4.60767f}, // 25
	{506.038f, 139.517f, 395.288f, 4.60767f}, // 26
	{608.116f, 171.731f, 395.289f, 4.60767f}, // 27
	{586.344f, 184.078f, 395.283f, 4.60767f}, // 28
	{554.818f, 187.568f, 395.288f, 2.93215f}, // 29
};

const Position LightBulletsLoc[] =
{
	{612.118f, 118.844f, 395.287f, 0}, // 1
	{546.057f, 88.7691f, 395.284f, 0}, // 2
	{510.759f, 127.333f, 395.263f, 0}, // 3
	{592.151f, 183.8f,   395.279f, 0}, // 4
	{515.399f, 159.75f,  395.287f, 0}, // 5
	{557.743f, 187.729f, 395.915f, 0}, // 6
	{544.094f, 184.648f, 395.286f, 0}, // 7
	{551.328f, 187.646f, 395.596f, 0}, // 8
	{615.137f, 150.818f, 395.269f, 0}, // 9
	{571.158f, 187.691f, 395.629f, 0}, // 10
	{606.686f, 106.731f, 395.289f, 0}, // 11
	{507.181f, 142.285f, 395.255f, 0}, // 12
	{517.722f, 169.069f, 395.289f, 0}, // 13
	{524.257f, 178.134f, 395.29f,  0}, // 14
	{570.779f, 86.2986f, 395.253f, 0}, // 15
	{588.675f, 93.0938f, 395.289f, 0}, // 16
	{603.528f, 175.476f, 395.289f, 0}, // 17
	{509.639f, 133.26f,  395.247f, 0}, // 18
	{618.965f, 139.174f, 395.288f, 0}, // 19
	{514.785f, 118.731f, 395.287f, 0}, // 20
	{581.243f, 184.062f, 395.287f, 0}, // 21
	{577.757f, 184.436f, 395.289f, 0}, // 22
	{580.486f, 89.691f,  395.287f, 0}, // 23
	{511.132f, 151.156f, 395.264f, 0}, // 24
	{615.401f, 130.816f, 395.263f, 0}, // 25
	{599.307f, 98.8003f, 395.29f,  0}, // 26
	{520.212f, 108.429f, 395.289f, 0}, // 27
	{610.983f, 164.696f, 395.288f, 0}, // 28
	{526.337f, 99.5556f, 395.29f,  0}, // 29
	{563.997f, 187.644f, 395.489f, 0}, // 30
	{555.695f, 86.0208f, 395.253f, 0}, // 31
	{535.924f, 184.207f, 395.279f, 0}, // 32
};
...
enum InstanceSpells
{
	...
	SPELL_DESTROY_FLOOR_KNOCK_UP = 68193,
	SPELL_LEGION_LIGHTNING       = 67888,
	SPELL_ARTHAS_PORTAL          = 51807,
	SPELL_ARTHAS_FROST_NOVA      = 68198,
	SPELL_DALARAN_PORTAL         = 53142,
};

enum Creatures
{
    NPC_BARRENT                         = 34816,
    NPC_TIRION_FORDRING_1               = 34996,
	NPC_TIRION_FORDRING_2               = 36095,
	NPC_ARGENT_MAGE                     = 36097,
    NPC_WILFRED_FIZZLEBANG              = 35458,
    NPC_GARROSH_HELLSCREAM              = 34995,
    NPC_KING_VARIAN_WRYNN               = 34990,
    NPC_LICH_KING_0                     = 16980,
    NPC_LICH_KING_1                     = 35877,
    NPC_THRALL                          = 34994,
    NPC_JAINA_PROUDMOORE                = 34992,
    NPC_WILFRED_PORTAL                  = 17965,
    NPC_PURPLE_ARGENT_TRIGGER           = 35651,
    NPC_ICEHOWL                         = 34797,
    ...
    NPC_FEL_FELFLAME_INFERNAL           = 34815,
