...
class npc_winterfin_playmate : public CreatureScript
{
    public:
        ...
        struct npc_winterfin_playmateAI : public QuantumBasicAI
        {
            npc_winterfin_playmateAI(Creature* creature) : QuantumBasicAI (creature) {}
...
class npc_snowfall_glade_playmate : public CreatureScript
{
    public:
        ...
        struct npc_snowfall_glade_playmateAI : public QuantumBasicAI
        {
            npc_snowfall_glade_playmateAI(Creature* creature) : QuantumBasicAI (creature) {}
...
class npc_the_biggest_tree : public CreatureScript
{
    public:
        ...
        struct npc_the_biggest_treeAI : public QuantumBasicAI
        {
            npc_the_biggest_treeAI(Creature* creature) : QuantumBasicAI (creature)
            {
...
class npc_high_oracle_soo_roo : public CreatureScript
{
    public:
        ...
        struct npc_high_oracle_soo_rooAI : public QuantumBasicAI
        {
            npc_high_oracle_soo_rooAI(Creature* creature) : QuantumBasicAI (creature) {}
...
class npc_elder_kekek : public CreatureScript
{
    public:
        ...
        struct npc_elder_kekekAI : public QuantumBasicAI
        {
            npc_elder_kekekAI(Creature* creature) : QuantumBasicAI (creature) {}
...
class npc_the_etymidian : public CreatureScript
{
    public:
        ...
        struct npc_the_etymidianAI : public QuantumBasicAI
        {
            npc_the_etymidianAI(Creature* creature) : QuantumBasicAI (creature) {}
...
class npc_alexstraza_the_lifebinder : public CreatureScript
{
    public:
        ...
        struct npc_alexstraza_the_lifebinderAI : public QuantumBasicAI
        {
            npc_alexstraza_the_lifebinderAI(Creature* creature) : QuantumBasicAI (creature) {}
                ...
                if (timer <= diff)
                {
                    ...
                    switch (phase)
                    {
                        ...
                        case 7:
                            ...
                            break;
                        case 8:
                            if(Creature* krasus = me->FindCreatureWithDistance(NPC_KRASUS, 10.0f))
                            {
...
class npc_cw_area_trigger : public CreatureScript
{
    public:
        ...
        struct npc_cw_area_triggerAI : public QuantumBasicAI
        {
            npc_cw_area_triggerAI(Creature* creature) : QuantumBasicAI (creature)
            {
                me->SetDisplayId(MODEL_ID_INVISIBLE);
            }
                                ...
                                case NPC_SILVERMOON_01_CW_TRIGGER:
                                    if (player->GetQuestStatus(QUEST_NOW_WHEN_I_GROW_UP) == QUEST_STATUS_INCOMPLETE && getOrphanGUID(player, ORPHAN_BLOOD_ELF))
                                    {
                                        ...
                                        if (player->GetQuestStatus(QUEST_NOW_WHEN_I_GROW_UP) == QUEST_STATUS_COMPLETE)
                                            if (Creature* samuro = me->FindCreatureWithDistance(25151, 20.0f))
                                            {
                                                uint32 emote = 0;
                                                switch(urand(1,5))
                                                {
...
class npc_grizzlemaw_cw_trigger : public CreatureScript
{
    public:
        ...
        struct npc_grizzlemaw_cw_triggerAI : public QuantumBasicAI
        {
            npc_grizzlemaw_cw_triggerAI(Creature* creature) : QuantumBasicAI(creature)
            {
                me->SetDisplayId(MODEL_ID_INVISIBLE);
            }
