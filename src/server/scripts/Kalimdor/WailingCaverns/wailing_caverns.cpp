...
public:
	...
	bool OnGossipHello(Player* player, Creature* creature)
    {
			...
			(instance->GetData(TYPE_LADY_ANACONDRA) == DONE) && (instance->GetData(TYPE_LORD_SERPENTIS) == DONE))
		{
			...
			{
				DoSendQuantumText(SAY_AT_LAST, creature);
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
    {
        ...
        if (action == GOSSIP_ACTION_INFO_DEF + 1)
        {
            ...
            DoSendQuantumText(SAY_MAKE_PREPARATIONS, creature);

            creature->SetCurrentFaction(250);
    ...
    struct npc_disciple_of_naralexAI : public npc_escortAI
    {
        ...
        void WaypointReached(uint32 i)
        {
            ...
            switch (i)
            {
                case 4:
					...
					break;
                case 5:
                    DoSendQuantumText(SAY_MUST_CONTINUE, me);
                ...
                case 11:
					...
					break;
                case 19:
                    DoSendQuantumText(SAY_BEYOND_THIS_CORRIDOR, me);
					break;
                case 24:
                    EventProgress = 1;
        ...
        {
            DoSendQuantumText(SAY_ATTACKED, me, who);
        }
                ...
                if (instance->GetData(CurrentEvent) == IN_PROGRESS)
                {
                    switch (CurrentEvent)
                    {
                        case TYPE_NARALEX_PART1:
                            ...
                            {
                                ++EventProgress;
                                DoSendQuantumText(SAY_TEMPLE_OF_PROMISE, me);
                        ...
                        case TYPE_NARALEX_PART2:
                            ...
                            {
                                ++EventProgress;
                                DoSendQuantumText(SAY_BANISH_THE_SPIRITS, me);
                            ...
                            if (EventProgress == 2)
                            {
                                ...
                                DoSendQuantumText(SAY_CAVERNS_PURIFIED, me);
                        ...
                        case TYPE_NARALEX_PART3:
                            if (EventProgress == 1)
                            {
                                ...
                                DoSendQuantumText(SAY_EMERALD_DREAM, me);
                            }
                            else
                            if (EventProgress == 2)
                            {
                                ...
                                DoSendQuantumText(EMOTE_AWAKENING_RITUAL, me);
                            }
                            else
                            if (EventProgress == 3)
                            {
                                ...
                                EventTimer = 15000;
                                if (Creature* naralex = instance->instance->GetCreature(instance->GetData64(DATA_NARALEX)))
                                    DoSendQuantumText(EMOTE_TROUBLED_SLEEP, naralex);
                            ...
                            if (EventProgress == 4)
                            {
                                ...
                                EventTimer = 30000;
                                if (Creature* naralex = instance->instance->GetCreature(instance->GetData64(DATA_NARALEX)))
                                    DoSendQuantumText(EMOTE_WRITHE_IN_AGONY, naralex);
                            ...
                            if (EventProgress == 6 && instance->GetData(TYPE_MUTANUS_THE_DEVOURER) == DONE)
                            {
                                ...
                                if (Creature* naralex = instance->instance->GetCreature(instance->GetData64(DATA_NARALEX)))
                                {
                                    ...
                                    DoSendQuantumText(SAY_I_AM_AWAKE, naralex);
                                }
                                DoSendQuantumText(SAY_NARALEX_AWAKES, me);
                            }
                            else
                            if (EventProgress == 7)
                            {
                                ...
                                EventTimer = 6000;
                                if (Creature* naralex = instance->instance->GetCreature(instance->GetData64(DATA_NARALEX)))
                                    DoSendQuantumText(SAY_THANK_YOU, naralex);
                            }
                            else
                            if (EventProgress == 8)
                            {
                                ...
                                if (Creature* naralex = instance->instance->GetCreature(instance->GetData64(DATA_NARALEX)))
                                {
                                    DoSendQuantumText(SAY_FAREWELL, naralex);
