...
public:
    ...
    struct npc_tomb_creatureAI : public QuantumBasicAI
    {
        npc_tomb_creatureAI(Creature* creature) : QuantumBasicAI(creature)
        {
