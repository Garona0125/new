...
public:
    ...
    struct eye_of_cthunAI : public QuantumBasicAI
    {
        eye_of_cthunAI(Creature* creature) : QuantumBasicAI(creature)
        {
        ...
        void Reset()
        {
            ...
            if (Creature* pPortal= me->FindCreatureWithDistance(NPC_CTHUN_PORTAL, 10.0f))
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            switch (currentPhase)
            {
                ...
                case PHASE_CTHUN_DONE:
                    Creature* portal= me->FindCreatureWithDistance(NPC_CTHUN_PORTAL, 10.0f);
                    if (portal)
                        portal->DespawnAfterAction();
...
public:
    ...
    struct cthunAI : public QuantumBasicAI
    {
        cthunAI(Creature* creature) : QuantumBasicAI(creature)
        {
			SetCombatMovement(false);
            ...
            switch (currentPhase)
            {
                ...
                case PHASE_CTHUN_STOMACH:
                    ...
                    if (FleshTentaclesKilled > 1)
                    {
                        ...
                        DoSendQuantumText(EMOTE_WEAKENED, me);
                        PhaseTimer = 45000;
...
public:
    ...
    struct eye_tentacleAI : public QuantumBasicAI
    {
        eye_tentacleAI(Creature* creature) : QuantumBasicAI(creature)
        {
        ...
        {
            if (Unit* player = Unit::GetUnit(*me, Portal))
                player->Kill(player);
        }
...
public:
    ...
    struct claw_tentacleAI : public QuantumBasicAI
    {
        claw_tentacleAI(Creature* creature) : QuantumBasicAI(creature)
        {
            if (Creature* pPortal = me->SummonCreature(NPC_SMALL_PORTAL, *me, TEMPSUMMON_CORPSE_DESPAWN))
            {
                pPortal->SetReactState(REACT_PASSIVE);
...
public:
    ...
    struct giant_claw_tentacleAI : public QuantumBasicAI
    {
        giant_claw_tentacleAI(Creature* creature) : QuantumBasicAI(creature)
        {
...
public:
    ...
    struct giant_eye_tentacleAI : public QuantumBasicAI
    {
        giant_eye_tentacleAI(Creature* creature) : QuantumBasicAI(creature)
        {
            if (Creature* pPortal = me->SummonCreature(NPC_GIANT_PORTAL, *me, TEMPSUMMON_CORPSE_DESPAWN))
            {
                pPortal->SetReactState(REACT_PASSIVE);
...
public:
    ...
    struct flesh_tentacleAI : public QuantumBasicAI
    {
        flesh_tentacleAI(Creature* creature) : QuantumBasicAI(creature)
        {
            SetCombatMovement(false);
        }
