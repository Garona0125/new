...
class boss_ossirian_the_unscarred : public CreatureScript
{
    public:
        boss_ossirian_the_unscarred() : CreatureScript("boss_ossirian_the_unscarred") { }

        struct boss_ossirian_the_unscarredAI : public BossAI
        {
            boss_ossirian_the_unscarredAI(Creature* creature) : BossAI(creature, DATA_OSSIRIAN)
            {
                SaidIntro = false;
                Reset();
            }
        ...
        {
            return new boss_ossirian_the_unscarredAI (creature);
        }
};
...
public:
	...
	bool OnGossipHello(Player* player, GameObject* /*go*/)
	{
		...
		Creature* Ossirian = player->FindCreatureWithDistance(NPC_OSSIRIAN, 250.0f);
...
{
    new boss_ossirian_the_unscarred();
