...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand debugCommandTable[] =
        {
            ...
            { "anim",           SEC_GAME_MASTER,    false, &HandleDebugAnimCommand,            "", NULL },
            ...
            { "lootrecipient",  SEC_GAME_MASTER,    false, &HandleDebugGetLootRecipientCommand, "", NULL },
    ...
    static bool HandleDebugSendOpcodeCommand(ChatHandler* handler, char const* /*args*/)
    {
        ...
        while (!parsedStream.eof())
        {
            ...
            {
                sLog->OutErrorConsole("Sending opcode that has unknown type '%s'", type.c_str());
                break;
            }
        }
