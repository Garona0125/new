...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "assign",         SEC_GAME_MASTER,    true,  &HandleGMTicketAssignToCommand,          "", NULL },
            ...
            { "escalatedlist",  SEC_GAME_MASTER,    true,  &HandleGMTicketListEscalatedCommand,     "", NULL },
            ...
            { "unassign",       SEC_GAME_MASTER,    true,  &HandleGMTicketUnAssignCommand,          "", NULL },
    ...
    static bool HandleGMTicketUnAssignCommand(ChatHandler* handler, char const* args)
    {
        ...
        uint32 mySecurity = handler->GetSession() ? handler->GetSession()->GetSecurity() : SEC_MAIN_ADMINISTRATOR;
