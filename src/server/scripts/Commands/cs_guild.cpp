...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "create",         SEC_GAME_MASTER,    true,  &HandleGuildCreateCommand,           "", NULL },
            { "delete",         SEC_GAME_MASTER,    true,  &HandleGuildDeleteCommand,           "", NULL },
            { "invite",         SEC_GAME_MASTER,    true,  &HandleGuildInviteCommand,           "", NULL },
            { "uninvite",       SEC_GAME_MASTER,    true,  &HandleGuildUninviteCommand,         "", NULL },
            { "rank",           SEC_GAME_MASTER,    true,  &HandleGuildRankCommand,             "", NULL },
			{ "rename",         SEC_GAME_MASTER,    true,  &HandleGuildRenameCommand,           "", NULL },
			{ "info",           SEC_GAME_MASTER,    true,  &HandleGuildInfoCommand,             "", NULL },
			{ "linfo",          SEC_PLAYER,         true,  &HandleGuildLInfoCommand,            "", NULL },
			{ "setlevel",       SEC_GAME_MASTER,    true,  &HandleGuildSetLevelCommand,         "", NULL },
			{ "givexp",         SEC_GAME_MASTER,    true,  &HandleGuildGiveXpCommand,           "", NULL },
	...
	static bool HandleGuildSetLevelCommand(ChatHandler* handler, char const* args)
	{
		...
		if (guild)
		{
			...
			else guild->SetLevel(newLevel, true);
		}
		else
		{
