...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "temp",           SEC_GAME_MASTER,    false, &HandleGameObjectAddTempCommand,   "", NULL },
            { "",               SEC_GAME_MASTER,    false, &HandleGameObjectAddCommand,       "", NULL },
            { NULL,             0,                  false, NULL,                              "", NULL }
        };
        static ChatCommand gobjectSetCommandTable[] =
        {
            { "phase",          SEC_GAME_MASTER,    false, &HandleGameObjectSetPhaseCommand,  "", NULL },
            { "state",          SEC_GAME_MASTER,    false, &HandleGameObjectSetStateCommand,  "", NULL },
            { NULL,             0,                  false, NULL,                              "", NULL }
        };
        static ChatCommand gobjectCommandTable[] =
        {
            { "activate",       SEC_GAME_MASTER,    false, &HandleGameObjectActivateCommand,  "", NULL },
            { "delete",         SEC_GAME_MASTER,    false, &HandleGameObjectDeleteCommand,    "", NULL },
            { "info",           SEC_GAME_MASTER,    false, &HandleGameObjectInfoCommand,      "", NULL },
            { "move",           SEC_GAME_MASTER,    false, &HandleGameObjectMoveCommand,      "", NULL },
            { "near",           SEC_GAME_MASTER,    false, &HandleGameObjectNearCommand,      "", NULL },
            { "target",         SEC_GAME_MASTER,    false, &HandleGameObjectTargetCommand,    "", NULL },
            { "turn",           SEC_GAME_MASTER,    false, &HandleGameObjectTurnCommand,      "", NULL },
            { "add",            SEC_GAME_MASTER,    false, NULL,            "", gobjectAddCommandTable },
            { "set",            SEC_GAME_MASTER,    false, NULL,            "", gobjectSetCommandTable },
            { NULL,             0,                  false, NULL,                              "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "gobject",        SEC_GAME_MASTER,    false, NULL,                "", gobjectCommandTable },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        return commandTable;
    }
    ...
    static bool HandleGameObjectAddCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (objectInfo->displayId && !sGameObjectDisplayInfoStore.LookupEntry(objectInfo->displayId))
        {
            ...
            sLog->OutErrorDatabase("Gameobject (Entry %u GoType: %u) have invalid displayId (%u), not spawned.", objectId, objectInfo->type, objectInfo->displayId);
    ...
    static bool HandleGameObjectInfoCommand(ChatHandler* handler, char const* args)
    {
        ...
        else if (type == GAMEOBJECT_TYPE_FISHING_HOLE)
