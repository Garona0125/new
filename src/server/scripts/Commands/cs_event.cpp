...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "activelist",     SEC_GAME_MASTER,    true,  &HandleEventActiveListCommand,     "", NULL },
            { "start",          SEC_GAME_MASTER,    true,  &HandleEventStartCommand,          "", NULL },
            { "stop",           SEC_GAME_MASTER,    true,  &HandleEventStopCommand,           "", NULL },
            { "",               SEC_GAME_MASTER,    true,  &HandleEventInfoCommand,           "", NULL },
            { NULL,             0,                  false, NULL,                              "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "event",          SEC_GAME_MASTER,    false, NULL,                  "", eventCommandTable },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        return commandTable;
    }
    ...
    static bool HandleEventActiveListCommand(ChatHandler* handler, char const* /*args*/)
    {
        ...
        char const* active = handler->GetQuantumSystemText(LANG_ACTIVE);
    ...
    static bool HandleEventInfoCommand(ChatHandler* handler, char const* args)
    {
        ...
        char const* activeStr = active ? handler->GetQuantumSystemText(LANG_ACTIVE) : "";
