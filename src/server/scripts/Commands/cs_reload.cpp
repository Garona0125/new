...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand reloadCommandTable[] =
        {
            ...
            { "creature_linked_respawn",      SEC_ADMINISTRATOR, true,  &HandleReloadLinkedRespawnCommand,              "", NULL },
            { "creature_loot_template",       SEC_ADMINISTRATOR, true,  &HandleReloadLootTemplatesCreatureCommand,      "", NULL },
			{ "creature_model_info",          SEC_ADMINISTRATOR, true,  &HandleReloadCreatureModelInfoCommand,          "", NULL },
            ...
            { "creature_template_entry",      SEC_ADMINISTRATOR, true,  &HandleReloadCreatureTemplateEntryCommand,      "", NULL },
			...
			{ "game_event",                   SEC_ADMINISTRATOR, true,  &HandleReloadGameEventCommand,                  "", NULL },
            { "game_teleportation_zones",     SEC_ADMINISTRATOR, true,  &HandleReloadGameTeleCommand,                   "", NULL },
			{ "gameobject_template",          SEC_ADMINISTRATOR, true,  &HandleReloadGameobjectTemplateCommand,         "", NULL },
			{ "gameobject_addon",             SEC_ADMINISTRATOR, true,  &HandleReloadGameobjectAddonCommand,            "", NULL },
            ...
            { "locales_gossip_menu_texts",    SEC_ADMINISTRATOR, true,  &HandleReloadLocalesGossipMenuTextsCommand,     "", NULL },
            ...
            { "quantum_system_texts",         SEC_ADMINISTRATOR, true,  &HandleReloadQuantumSystemTextCommand,          "", NULL },
			...
			{ "chat_filter",                  SEC_ADMINISTRATOR, true,  &HandleReloadChatFilterCommand,                 "", NULL },
			{ "mod_auto_learn",               SEC_ADMINISTRATOR, true,  &HandleReloadAutoLearnSpellsCommand,            "", NULL },
			{ "mod_multi_kill",               SEC_ADMINISTRATOR, true,  &HandleReloadMultiKillCommand,                  "", NULL },
            { NULL,                           0,                 false, NULL,                                           "", NULL }
        };
    ...
    static bool HandleReloadAllCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        HandleReloadQuantumSystemTextCommand(handler, "");
    ...
    {
        sLog->OutConsole("Reloading Loot Tables...");
        LoadLootTables();
    ...
    static bool HandleReloadAllQuestCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        sLog->OutConsole("Reloading Quests Relations...");
    ...
    static bool HandleReloadAllScriptsCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        sLog->OutConsole("Reloading Scripts...");
    ...
    static bool HandleReloadAllLocalesCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        HandleReloadLocalesGossipMenuTextsCommand(handler, "a");
    ...
    {
        sLog->OutConsole("Reloading World Config Settings...");
    ...
    {
        sLog->OutConsole("Reloading Access Requirement Definitions...");
    ...
    {
        sLog->OutConsole("Reloading Additional Achievement Criteria Data...");
    ...
    {
        sLog->OutConsole("Reloading Achievement Reward Data...");
    ...
    {
        sLog->OutConsole("Reloading Tavern Area Triggers...");
    ...
    {
        sLog->OutConsole("Reloading AreaTrigger Teleport Definitions...");
    ...
    {
        sLog->OutConsole("Reloading Autobroadcasts...");
    ...
    {
		sLog->OutConsole("Reloading Server Command Data...");
    ...
    {
        sLog->OutConsole("Reloading Creature Award Reputation...");
	...
	{
		sLog->OutConsole("Reloading Creature Summon Groups...");
		sObjectMgr->LoadTempSummons();
		handler->SendGlobalGMSysMessage("DB table `creature_summon_groups` reloaded.");
		return true;
	}

    static bool HandleReloadCreatureTemplateEntryCommand(ChatHandler* handler, const char* args)
    {
        if (!*args)
            return false;
        ...
        for (Tokens::const_iterator itr = entries.begin(); itr != entries.end(); ++itr)
        {
            ...
            sLog->OutConsole("Reloading Creature Entry %u", entry);
        ...
        handler->SendGlobalGMSysMessage("Creature Specify Entry Reloaded.");
        return true;
    }

    static bool HandleReloadCreatureQuestRelationsCommand(ChatHandler* handler, const char* /*args*/)
    {
        sLog->OutConsole("Reloading Creature Quests Relations...");
    ...
    {
        sLog->OutConsole("Reloading Creature Linked Respawns...");
    ...
    {
        sLog->OutConsole("Reloading Quest InvolvedRelations...");
    ...
    {
        sLog->OutConsole("Reloading Gossip Menus...");
    ...
    {
        sLog->OutConsole("Reloading Gossip Menu Options...");
    ...
    {
        sLog->OutConsole("Reloading Gameobject Quest Relations...");
    ...
    {
        sLog->OutConsole("Reloading Gameobject Quest Involved Relations...");
    ...
    {
        sLog->OutConsole("Reloading Quest Area Triggers...");
    ...
    {
        sLog->OutConsole("Reloading Quest Templates...");
        sObjectMgr->LoadQuests();
        handler->SendGlobalGMSysMessage("DB table `quest_template` (quest definitions) reloaded.");

        sLog->OutConsole("Reloading GameObjects For Quests...");
    ...
    {
        sLog->OutConsole("Reloading Creature Model Info Data...");
    ...
    {
        sLog->OutConsole("Reloading Loot For Creature Loot Template...");
    ...
    {
        sLog->OutConsole("Reloading Disenchant Loot Template...");
    ...
    {
        sLog->OutConsole("Reloading Fishing Loot Template...");
    ...
    {
        sLog->OutConsole("Reloading Gameobject Loot Template...");
    ...
    {
        sLog->OutConsole("Reloading Item Loot Template...");
    ...
    {
        sLog->OutConsole("Reloading Milling Loot Template...");
    ...
    {
        sLog->OutConsole("Reloading Pickpocketing Loot Template...");
    ...
    {
        sLog->OutConsole("Reloading Prospecting Loot Template...");
    ...
    {
        sLog->OutConsole("Reloading Mail Loot Template...");
    ...
    {
        sLog->OutConsole("Reloading Reference Loot Template...");
    ...
    {
        sLog->OutConsole("Reloading Skinning Loot Template...");
    ...
    {
        sLog->OutConsole("Reloading Spell Loot Template...");
    ...
    static bool HandleReloadQuantumSystemTextCommand(ChatHandler* handler, const char* /*args*/)
    {
        sLog->OutConsole("Reloading QuantumCore Texts...");
		sObjectMgr->LoadQuantumSystemTexts();
        handler->SendGlobalGMSysMessage("DB table `quantum_core_texts` reloaded.");
        return true;
    }
	...
	static bool HandleReloadWardenActionCommand(ChatHandler* handler, const char* /*args*/)
	{
		...
		sLog->OutConsole("Reloading Warden Actions...");
    ...
    {
        sLog->OutConsole("Reloading Trainers Data...");
    ...
    {
        sLog->OutConsole("Reloading Vendors Data...");
    ...
    {
        sLog->OutConsole("Reloading Quest Points of Interest...");
    ...
    {
        sLog->OutConsole("Reloading Quest Poi Points..." );
    ...
    {
        sLog->OutConsole("Reloading `npc_spellclick_spells` Table!");
    ...
    {
        sLog->OutConsole("Reloading Reserved Names...");
    ...
    {
        sLog->OutConsole("Reloading Reputation Reward Rate..." );
    ...
    {
        sLog->OutConsole("Reloading Reputation Spillover Template..." );
    ...
    {
        sLog->OutConsole("Reloading Skill Discovery Data...");
	...
	{
		sLog->OutConsole("ReLoading Skill Perfection Data Table...");
    ...
    {
        sLog->OutConsole("Reloading Skill Extra Item Data...");
    ...
    {
        sLog->OutConsole("Reloading Skill Fishing Level...");
    ...
    {
        sLog->OutConsole("Reloading Spell Area Data...");
    ...
    {
        sLog->OutConsole("Reloading Spell Required Data...");
    ...
    {
        sLog->OutConsole("Reloading Spell Groups...");
    ...
    {
        sLog->OutConsole("Reloading Spell Learn Spells...");
    ...
    {
        sLog->OutConsole("Reloading Spell Linked Spells Data...");
    ...
    {
        sLog->OutConsole("Reloading Spell Proc Event Data...");
    ...
    {
        sLog->OutConsole("Reloading Spell Proc Conditions...");
    ...
    {
        sLog->OutConsole("Reloading Spell Bonus Data...");
    ...
    {
        sLog->OutConsole("Reloading Spell Target Coordinates...");
    ...
    {
        sLog->OutConsole("Reloading Aggro Spells Definitions...");
    ...
    {
        sLog->OutConsole("Reloading Spell Group Stack Rules...");
    ...
    {
        sLog->OutConsole("Reloading Spell Pet Auras...");
    ...
    {
        sLog->OutConsole("Reloading Page Texts...");
    ...
    {
        sLog->OutConsole("Reloading Item Random Enchantments...");
	...
	{
		sLog->OutConsole("Reloading Item Template Data...");
    ...
    {
        sLog->OutConsole("Reloading Item Set Names...");
    ...
    static bool HandleReloadGameObjectScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            sLog->OutConsole("Reloading Scripts from `gameobject_scripts`...");
    ...
    static bool HandleReloadEventScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            sLog->OutConsole("Reloading Scripts From `event_scripts`...");
    ...
    static bool HandleReloadWpScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            sLog->OutConsole("Reloading Scripts From `waypoint_scripts`...");
    ...
    {
        if (*args != 'a')
            sLog->OutConsole("Reloading Waypoints data from 'waypoints_data'");
    ...
    {
        sLog->OutConsole("Reloading Texts From `creature_ai_texts`...");
    ...
    {
        sLog->OutConsole("Reloading Scripts From `creature_ai_scripts`...");
    ...
    static bool HandleReloadQuestEndScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            sLog->OutConsole("Reloading Scripts from `quest_end_scripts`...");
    ...
    static bool HandleReloadQuestStartScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            sLog->OutConsole("Reloading Scripts From `quest_start_scripts`...");
    ...
    static bool HandleReloadSpellScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            sLog->OutConsole("Reloading Scripts From `spell_scripts`...");
    ...
    {
        sLog->OutConsole("Reloading Script Strings From `db_script_string`...");
    ...
    {
        sLog->OutConsole("Reloading Graveyard Zones...");
        sObjectMgr->LoadGraveyardZones();
        handler->SendGlobalGMSysMessage("DB table `game_graveyard_zone` reloaded.");
        return true;
    }

	static bool HandleReloadGameEventCommand(ChatHandler* handler, const char* /*args*/)
    {
        sLog->OutConsole("Reloading Game Event Data...");
    ...
    {
        sLog->OutConsole("Reloading Game Teleport Coordinates...");
        sObjectMgr->LoadGameTele();
        handler->SendGlobalGMSysMessage("DB table `game_teleportation_zones` reloaded.");
        return true;
    }

	static bool HandleReloadGameobjectTemplateCommand(ChatHandler* handler, const char* /*args*/)
    {
        sLog->OutConsole("Reloading Gameobject Templates...");
        sObjectMgr->LoadGameObjectTemplate();
        handler->SendGlobalGMSysMessage("DB table `gameobject_template` reloaded.");
        return true;
    }

	static bool HandleReloadGameobjectAddonCommand(ChatHandler* handler, const char* /*args*/)
    {
        sLog->OutConsole("Reloading Gameobject Addons Data...");
        sObjectMgr->LoadGameObjectAddons();
        handler->SendGlobalGMSysMessage("DB table `gameobject_addon` reloaded.");
        return true;
    }

    static bool HandleReloadDisablesCommand(ChatHandler* handler, const char* /*args*/)
    {
        sLog->OutConsole("Reloading Disables Table...");
    ...
    {
        sLog->OutConsole("Reloading Locales Achievement Reward Data...");
    ...
    {
        sLog->OutConsole("Reloading lfg dungeon rewards...");
        sLFGMgr->LoadRewards();
    ...
    {
        sLog->OutConsole("Reloading Locales Creature...");
    ...
    {
        sLog->OutConsole("Reloading Locales Creature Texts...");
    ...
    {
        sLog->OutConsole("Reloading Locales Gameobject...");
    ...
    {
        sLog->OutConsole("Reloading Locales Gossip Menu Options...");
    ...
    {
        sLog->OutConsole("Reloading Locales Item Template...");
    ...
    {
        sLog->OutConsole("Reloading Locales Item set names...");
        sObjectMgr->LoadItemSetNameLocales();
        handler->SendGlobalGMSysMessage("DB table `locales_item_set_name` reloaded.");
        return true;
    }

    static bool HandleReloadLocalesGossipMenuTextsCommand(ChatHandler* handler, const char* /*args*/)
    {
        sLog->OutConsole("Reloading Locales Gossip Menu Texts...");
        sObjectMgr->LoadNpcTextLocales();
        handler->SendGlobalGMSysMessage("DB table `locales_gossip_menu_texts` reloaded.");
        return true;
    }

    static bool HandleReloadLocalesPageTextCommand(ChatHandler* handler, const char* /*args*/)
    {
        sLog->OutConsole("Reloading Locales Page Text...");
    ...
    {
        sLog->OutConsole("Reloading Locales Points Of Interest...");
    ...
    {
        sLog->OutConsole("Reloading Locales Quest...");
    ...
    {
        sLog->OutConsole("Reloading Player Level Dependent Mail Rewards...");
    ...
    {
        sLog->OutConsole("Reloading Auctions...");
    ...
    {
        sLog->OutConsole("Reloading Conditions...");
        sConditionMgr->LoadConditions(true);
        handler->SendGlobalGMSysMessage("DB table `conditions` reloaded.");
        return true;
    }

    static bool HandleReloadCreatureText(ChatHandler* handler, const char* /*args*/)
    {
        sLog->OutConsole("Reloading Creature Texts...");
        sCreatureTextMgr->LoadCreatureTexts();
        handler->SendGlobalGMSysMessage("DB table `creature_text` reloaded.");
        return true;
    }

    static bool HandleReloadSmartScripts(ChatHandler* handler, const char* /*args*/)
    {
        sLog->OutConsole("Reloading Smart Scripts...");
        sSmartScriptMgr->LoadSmartAIFromDB();
        handler->SendGlobalGMSysMessage("DB table `smart_scripts` reloaded.");
        return true;
    }

    static bool HandleReloadVehicleTemplateAccessoryCommand(ChatHandler* handler, const char* /*args*/)
    {
        sLog->OutConsole("Reloading vehicle_template_accessory table...");
        sObjectMgr->LoadVehicleTemplateAccessories();
        handler->SendGlobalGMSysMessage("DB table `vehicle_template_accessories` reloaded.");
        return true;
    }

	static bool HandleReloadChatFilterCommand(ChatHandler* handler, char const* /*args*/)
	{
		sLog->OutConsole("Reloading Chat Filter Data...");
		sObjectMgr->LoadChatFilter();
		handler->SendGlobalGMSysMessage("DB table `chat_filter` reloaded.");
		return true;
	}

	static bool HandleReloadAutoLearnSpellsCommand(ChatHandler* handler, char const* /*args*/)
	{
		sLog->OutConsole("Reloading Auto Learn Spell Data...");
		handler->SendGlobalGMSysMessage("DB table `mod_auto_learn` reloaded.");
		return true;
	}

	static bool HandleReloadMultiKillCommand(ChatHandler* handler, char const* /*args*/)
	{
		sLog->OutConsole("Reloading Multi Kill Data...");
		handler->SendGlobalGMSysMessage("DB table `mod_multi_kill` reloaded.");
		return true;
	}
};
