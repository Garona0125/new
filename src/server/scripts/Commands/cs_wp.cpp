...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "add",            SEC_GAME_MASTER,    false, &HandleWpAddCommand,                "", NULL },
            { "event",          SEC_GAME_MASTER,    false, &HandleWpEventCommand,              "", NULL },
            { "load",           SEC_GAME_MASTER,    false, &HandleWpLoadCommand,               "", NULL },
            { "modify",         SEC_GAME_MASTER,    false, &HandleWpModifyCommand,             "", NULL },
            { "unload",         SEC_GAME_MASTER,    false, &HandleWpUnLoadCommand,             "", NULL },
            { "reload",         SEC_ADMINISTRATOR,  false, &HandleWpReloadCommand,             "", NULL },
            { "show",           SEC_GAME_MASTER,    false, &HandleWpShowCommand,               "", NULL },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "wp",             SEC_GAME_MASTER,    false, NULL,                     "", wpCommandTable },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        return commandTable;
    }
