...
struct emerald_dragonAI : public WorldBossAI
{
    ...
    void UpdateAI(uint32 const diff)
    {
        ...
        if (Unit* target = SelectTarget(TARGET_TOP_AGGRO, 0, -50.0f, true))
...
class npc_dream_fog : public CreatureScript
{
    public:
        ...
        struct npc_dream_fogAI : public QuantumBasicAI
        {
            npc_dream_fogAI(Creature* creature) : QuantumBasicAI(creature){}
...
class boss_lethon : public CreatureScript
{
    public:
        ...
        struct boss_lethonAI : public emerald_dragonAI
        {
            ...
            {
                if (spell->Id == SPELL_DRAW_SPIRIT && target->GetTypeId() == TYPE_ID_PLAYER)
                {
                    Position targetPos;
    ...
    public:
        ...
        struct boss_taerarAI : public emerald_dragonAI
        {
            ...
            void EnterToBattle(Unit* who)
            {
                ...
                emerald_dragonAI::EnterToBattle(who);
            }
