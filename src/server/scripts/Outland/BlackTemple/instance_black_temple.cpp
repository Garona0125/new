...
public:
    ...
    struct instance_black_temple_InstanceMapScript : public InstanceScript
    {
        ...
        Player* GetPlayerInMap()
        {
            ...
            sLog->outDebug(LOG_FILTER_QCSCR, "QUANTUMCORE SCRIPTS: Instance Black Temple: GetPlayerInMap, but PlayerList is empty!");
            return NULL;
        }
        ...
        void OnGameObjectCreate(GameObject* go)
        {
            ...
            case 185483:
				...
				break;
            case 185882:
				MainTempleDoors = go->GetGUID();// Main Temple Doors - right past (Supremus)
        ...
        void Load(const char* in)
        {
            ...
            uint32 Temp_Encounter[MAX_ENCOUNTERS];
