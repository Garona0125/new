...
class ByteBufferPositionException : public ByteBufferException
{
    ...
    protected:
        ...
        {
            sLog->OutErrorConsole("Attempted to %s value with size: "SIZEFMTD" in ByteBuffer (pos: " SIZEFMTD " size: "SIZEFMTD") " , (_add ? "put" : "get"), ValueSize, Pos, Size);
        }
...
class ByteBufferSourceException : public ByteBufferException
{
    ...
    protected:
        void PrintError() const
        {
            sLog->OutErrorConsole("Attempted to put a %s in ByteBuffer (pos: "SIZEFMTD" size: "SIZEFMTD")", (ValueSize > 0 ? "NULL-pointer" : "zero-sized value"), Pos, Size);
        }
};
