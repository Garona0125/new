...
enum DebugLogFilters
{
    ...
    LOG_FILTER_QCSCR                    = 0x00000008,   // C++ AI, instance scripts, etc.
...
class Log
{
    ...
    public:
        ...
        void OutConsole(const char * str, ...)                  ATTR_PRINTF(2, 3);
        void OutConsole();
        void OutConsoleInLine(const char * str, ...)            ATTR_PRINTF(2, 3);
        void OutErrorConsole(const char * err, ...)             ATTR_PRINTF(2, 3);
        ...
        void OutErrorDatabase(const char * str, ...)            ATTR_PRINTF(2, 3);
        void OutCharacters(const char * str, ...)               ATTR_PRINTF(2, 3);
        void outCommand( uint32 account, const char * str, ...) ATTR_PRINTF(3, 4);
        void outRemote(const char * str, ...)                   ATTR_PRINTF(2, 3);
        void outChat(const char * str, ...)                     ATTR_PRINTF(2, 3);
        void outArena(const char * str, ... )                   ATTR_PRINTF(2, 3);
        void OutSQLConnection(const char* str, ...)             ATTR_PRINTF(2, 3);
		void outWarden(const char * str, ... )                  ATTR_PRINTF(2, 3);
        void OutCharactersDump(const char * str, uint32 account_id, uint32 guid, const char * name);
        ...
        bool IsOutCharactersDump() const { return m_charLog_Dump; }
