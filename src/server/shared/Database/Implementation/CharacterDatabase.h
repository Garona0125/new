...
enum CharacterDatabaseStatements
{
    ...
    CHAR_UPD_INSTANCE_RESET_TIME,
    CHAR_UPD_GLOBAL_INSTANCE_RESET_TIME,
    ...
    CHAR_DEL_CHAR_PET_DECLINED_NAME,
    CHAR_INS_CHAR_PET_DECLINED_NAME,
	...
	CHAR_SEL_PVP_STATS_MAX_ID,
	CHAR_INS_PVP_STATS_BATTLEGROUND,
	CHAR_INS_PVP_STATS_PLAYER,
	CHAR_SEL_PVP_STATS_FACTIONS_OVERALL,
    ...
    MAX_CHARACTER_DATA_BASE_STATEMENTS,
};
