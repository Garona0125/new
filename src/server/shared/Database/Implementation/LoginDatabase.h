...
enum LoginDatabaseStatements
{
    ...
    */
    ...
    LOGIN_DEL_OLD_LOGS,
    LOGIN_DEL_ACCOUNT_SECURITY,
    LOGIN_DEL_ACCOUNT_SECURITY_BY_REALM,
    LOGIN_INS_ACCOUNT_SECURITY,
	LOGIN_GET_ACCOUNT_ID_BY_USERNAME,
	LOGIN_GET_ACCOUNT_SECURITY_GM_LEVEL,
	LOGIN_GET_ACCOUNT_SECURITY_GM_LEVEL_BY_REALM_ID,
