...
enum BattlegroundSpells
{
	...
	SPELL_FREEZE_CHEATER            = 9454,                // Cast For Cheaters (Special For Battleground Anticheat)
};
...
class Battleground
{
    public:
		...
		void RewardItemId(Player *player, uint32 count);
		void RewardItem(Player *player, uint32 item_id, uint32 count);
        ...
        //to be removed
        const char* GetQuantumSystemText(int32 entry);
