...
uint32 ArenaTeamMgr::GenerateArenaTeamId()
{
    ...
    {
        sLog->OutErrorConsole("Arena team ids overflow!! Can't continue, shutting down server. ");
...
void ArenaTeamMgr::LoadArenaTeams()
{
    ...
    {
		sLog->OutConsole("========================================================");
        sLog->OutConsole(">> Loaded 0 arena teams. DB table `arena_team` is empty!");
		sLog->OutConsole("========================================================");
        sLog->OutConsole();
        return;
    }
	...
	sLog->OutConsole("===================================");
    sLog->OutConsole(">> Loaded %u arena teams in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
	sLog->OutConsole("===================================");
    sLog->OutConsole();
}
