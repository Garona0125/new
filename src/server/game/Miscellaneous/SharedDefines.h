...
#ifndef QUANTUM_SHARED_DEFINES_H
#define QUANTUM_SHARED_DEFINES_H
...
// Heal float percent values
#define HEAL_PERCENT_FULL 99.0f
#define HEAL_PERCENT_GREATER 65.0f
#define HEAL_PERCENT_DOT 85.0f
#define HEAL_PERCENT_LOW 40.0f
...
#define RACEMASK_ALL_PLAYABLE \
    ...
    (1<<(RACE_NIGHT_ELF-1))|(1<<(RACE_UNDEAD_PLAYER-1))|(1<<(RACE_TAUREN-1))  | \
    (1<<(RACE_GNOME-1))   |(1<<(RACE_TROLL-1))        |(1<<(RACE_BLOOD_ELF-1))| \
    (1<<(RACE_DRAENEI-1)))

#define RACEMASK_ALLIANCE \
    ((1<<(RACE_HUMAN-1)) | (1<<(RACE_DWARF-1)) | (1<<(RACE_NIGHT_ELF-1)) | \
...
enum SpellAttr6
{
    ...
    SPELL_ATTR6_ASSIST_IGNORE_IMMUNE_FLAG        = 0x00000008, //  3 skips checking UNIT_FLAG_NO_AGGRO_FOR_PLAYER and UNIT_FLAG_NO_AGGRO_FOR_CREATURE flags on assist
    ...
    SPELL_ATTR6_MOUNT_SPELL                      = 0x00020000, // 17 Mount spell
...
enum SpellImmunity
{
    ...
    IMMUNITY_AURA_TYPE             = 1,                     // enum AuraType
...
enum GameobjectTypes
{
    ...
    GAMEOBJECT_TYPE_AREA_DAMAGE            = 12,
    GAMEOBJECT_TYPE_CAMERA                 = 13,
    GAMEOBJECT_TYPE_MAP_OBJECT             = 14,
    GAMEOBJECT_TYPE_MO_TRANSPORT           = 15,
    GAMEOBJECT_TYPE_DUEL_ARBITER           = 16,
    GAMEOBJECT_TYPE_FISHING_NODE           = 17,
    GAMEOBJECT_TYPE_SUMMONING_RITUAL       = 18,
    GAMEOBJECT_TYPE_MAIL_BOX               = 19,
    GAMEOBJECT_TYPE_DO_NOT_USE             = 20,
    GAMEOBJECT_TYPE_GUARD_POST             = 21,
    GAMEOBJECT_TYPE_SPELL_CASTER           = 22,
    GAMEOBJECT_TYPE_MEETING_STONE          = 23,
    GAMEOBJECT_TYPE_FLAG_STAND             = 24,
    GAMEOBJECT_TYPE_FISHING_HOLE           = 25,
    GAMEOBJECT_TYPE_FLAG_DROP              = 26,
...
enum GameObjectFlags
{
    ...
    GO_FLAG_NO_DESPAWN      = 0x00000020,                   // never despawn, typically for doors, they just change state
...
{
    GO_DYNAMIC_FLAG_LO_ACTIVATE          = 0x01,                 // enables interaction with GO
    GO_DYNAMIC_FLAG_LO_ANIMATE           = 0x02,                 // possibly more distinct animation of GO
    GO_DYNAMIC_FLAG_LO_NO_INTERACT       = 0x04,                 // appears to disable interaction (not fully verified)
    GO_DYNAMIC_FLAG_LO_SPARKLE           = 0x08,                 // makes GO sparkle
};
...
enum Emote
{
    ...
    EMOTE_ONESHOT_ATTACK_1H             = 36,
    EMOTE_ONESHOT_ATTACK_2H_TIGHT       = 37,
    EMOTE_ONESHOT_ATTACK_2H_LOOSE       = 38,
    ...
    EMOTE_ONESHOT_SPECIAL_ATTACK_1H     = 54,
    ...
    EMOTE_ONESHOT_LIFT_OFF              = 254,
    EMOTE_ONESHOT_YES                   = 273,
    EMOTE_ONESHOT_NO                    = 274,
    EMOTE_ONESHOT_TRAIN                 = 275,
    EMOTE_ONESHOT_LAND                  = 293,
    EMOTE_STATE_AT_EASE                 = 313,
    EMOTE_STATE_READY_1H                = 333,
    EMOTE_STATE_SPELL_KNEEL_START       = 353,
    EMOTE_STATE_SUBMERGED               = 373,
    EMOTE_ONESHOT_SUBMERGE              = 374,
    EMOTE_STATE_READY_2H                = 375,
    ...
    EMOTE_ONESHOT_JUMP_LAND_RUN         = 394,
    EMOTE_ONESHOT_JUMPEND               = 395,
    EMOTE_ONESHOT_TALK_NO_SHEATHE       = 396,
    EMOTE_ONESHOT_POINT_NO_SHEATHE      = 397,
    EMOTE_STATE_CANNIBALIZE             = 398,
    EMOTE_ONESHOT_JUMPSTART             = 399,
    EMOTE_STATE_DANCE_SPECIAL           = 400,
    EMOTE_ONESHOT_DANCE_SPECIAL         = 401,
    ...
    EMOTE_ONESHOT_PARRY_1H              = 441,
    EMOTE_ONESHOT_PARRY_2H              = 442,
    EMOTE_ONESHOT_PARRY_2H_L            = 443,
    EMOTE_STATE_FLYFALL                 = 444,
    EMOTE_ONESHOT_FLY_DEATH             = 445,
    ...
    EMOTE_ONESHOT_FLY_GRAB              = 452,
    EMOTE_STATE_FLY_GRAB_CLOSED         = 453,
    EMOTE_ONESHOT_FLY_GRAB_THROWN       = 454,
    EMOTE_STATE_FLY_SIT_GROUND          = 455,
    EMOTE_STATE_WALK_BACKWARDS          = 456,
    EMOTE_ONESHOT_FLY_TALK              = 457,
    EMOTE_ONESHOT_FLY_ATTACK_1H         = 458,
...
enum Anim
{
    ...
    ANIM_CARRY_2H                          = 502,
    ANIM_CARRIED_2H                        = 503,
    ANIM_FLY_CARRY_2H                      = 504,
    ANIM_FLY_CARRIED_2H                    = 505
};
...
uint32 const CREATURE_TYPE_MASK_DEMON_OR_UNDEAD = (1 << (CREATURE_TYPE_DEMON-1)) | (1 << (CREATURE_TYPE_UNDEAD-1));
uint32 const CREATURE_TYPE_MASK_HUMANOID_OR_UNDEAD = (1 << (CREATURE_TYPE_HUMANOID-1)) | (1 << (CREATURE_TYPE_UNDEAD-1));
uint32 const CREATURE_TYPE_MASK_MECHANICAL_OR_ELEMENTAL = (1 << (CREATURE_TYPE_MECHANICAL-1)) | (1 << (CREATURE_TYPE_ELEMENTAL-1));
...
enum GenericTexts
{
	SAY_GENERIC_EMOTE_ENRAGE = -1240000,
	SAY_GENERIC_EMOTE_FRENZY = -1240001,
	SAY_GENERIC_EMOTE_FLEE   = -1240002
};

enum GlobalSpells
{
	SPELL_UNIT_DETECTION_ALL   = 18950,
	SPELL_UNIT_DETECTION_WOTLK = 67236,
	SPELL_GM_ON                = 18139,
	SPELL_GM_OFF               = 1509
};
...
enum PlayerPets
{
	...
	ENTRY_VIPER           = 19921,
	ENTRY_RISEN_GHOUL     = 26125,
	ENTRY_BLOODWORM       = 28017,
	ENTRY_EBON_GARGOYLE   = 27829,
	ENTRY_RUNE_WEAPON     = 27893,
	ENTRY_ARMY_DEAD_GHOUL = 24207,
...
enum WorldMisc
{
	...
	POWER_QUANTITY_MAX    = 100,

	HEALTH_PERCENT_95     = 95,
	HEALTH_PERCENT_90     = 90,
	HEALTH_PERCENT_85     = 85,
	HEALTH_PERCENT_80     = 80,
	HEALTH_PERCENT_75     = 75,
	HEALTH_PERCENT_70     = 70,
	HEALTH_PERCENT_65     = 65,
	HEALTH_PERCENT_60     = 60,
	HEALTH_PERCENT_55     = 55,
	HEALTH_PERCENT_50     = 50,
	HEALTH_PERCENT_45     = 45,
	HEALTH_PERCENT_40     = 40,
	HEALTH_PERCENT_35     = 35,
	HEALTH_PERCENT_30     = 30,
	HEALTH_PERCENT_25     = 25,
	HEALTH_PERCENT_20     = 20,
	HEALTH_PERCENT_15     = 15,
	HEALTH_PERCENT_10     = 10,
	HEALTH_PERCENT_5      = 5
};
...
{
	// 1
	FIELD_BYTE_1_SITTING          = 1,
	FIELD_BYTE_1_SIT_CHAIR        = 2,
	FIELD_BYTE_1_SLEEP            = 3,
	FIELD_BYTE_1_SIT_LOW_CHAIR    = 4,
	FIELD_BYTE_1_SIT_MEDIUM_CHAIR = 5,
	FIELD_BYTE_1_SIT_HIGH_CHAIR   = 6,
	FIELD_BYTE_1_SHOW_HEALTH      = 7,
	FIELD_BYTE_1_KNEEL            = 8,
	FIELD_BYTE_1_CUSTOM           = 9,
	FIELD_BYTE_1_HOVER            = 33554432,
	FIELD_BYTE_1_FLYING           = 50331648,
	// 2
	FIELD_BYTE_2_MELEE_WEAPON     = 1,
	FIELD_BYTE_2_RANGED_WEAPON    = 2
};

enum WinterBossModels
{
	// Classic
	MODEL_CHRISTMAS_DARKMASTER_GANDLING = 15732, // +
	MODEL_CHRISTMAS_MASTER_WILLEY       = 15733, // +
	MODEL_CHRISTMAS_PRINCE_TORTHELDRIN  = 15734, // need scripting npc
	MODEL_CHRISTMAS_DAGRAN_THAURISSAN   = 15735, // +
	MODEL_CHRISTMAS_WARCHIEF_BLACKHAND  = 15736, // need scripting npc
	MODEL_CHRISTMAS_WAR_MASTER_VOONE    = 15737, // +
	MODEL_CHRISTMAS_GORALUK_ANVILCRACK  = 15760, // need scripting npc
	// Burning Crusade
	MODEL_CHRISTMAS_WARLOCK_NETHERKURSE = 22800,
	MODEL_CHRISTMAS_GRAND_MASTER_VORPIL = 22801,
	MODEL_CHRISTMAS_EXARCH_MALADAAR     = 22802,
	MODEL_CHRISTMAS_CAPTAIN_SCARLOC     = 22803,
	MODEL_CHRISTMAS_SERPETHREA          = 22804,
	MODEL_CHRISTMAS_BOTANIST_FREYWINN   = 22805
};
