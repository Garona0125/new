...
#ifndef QUANTUM_SYSTEM_TEXT_H
#define QUANTUM_SYSTEM_TEXT_H

enum QuantumSystemTexts
{
    // for chat commands
...
//                                      = 726, not used
	...
	//                                  = 749, not used
    LANG_BATTLEGROUND_FINISH_WARNING_MIN = 750,  // "Not enough players. This game will close in %u mins."
    LANG_BATTLEGROUND_FINISH_WARNING_SEC = 751,  // "Not enough players. This game will close in %u seconds."
	//                                    = 752, not used
	...
	//Wg announce
	LANG_BG_WG_WORLD_ANNOUNCE_5_MIN     = 11002,
	LANG_BG_WG_WORLD_ANNOUNCE_4_MIN     = 11003,
	LANG_BG_WG_WORLD_ANNOUNCE_3_MIN     = 11004,
	LANG_BG_WG_WORLD_ANNOUNCE_2_MIN     = 11005,
	LANG_BG_WG_WORLD_ANNOUNCE_1_MIN     = 11006,
	LANG_BG_WG_WORLD_ANNOUNCE_30_SEC    = 11007,
	LANG_BG_WG_WORLD_ANNOUNCE_15_SEC    = 11008,
	LANG_BG_WG_WORLD_ANNOUNCE_10_SEC    = 11009,
	LANG_BG_WG_WORLD_ANNOUNCE_9_SEC     = 11010,
	LANG_BG_WG_WORLD_ANNOUNCE_8_SEC     = 11011,
	LANG_BG_WG_WORLD_ANNOUNCE_7_SEC     = 11012,
	LANG_BG_WG_WORLD_ANNOUNCE_6_SEC     = 11013,
	LANG_BG_WG_WORLD_ANNOUNCE_5_SEC     = 11014,
	LANG_BG_WG_WORLD_ANNOUNCE_4_SEC     = 11015,
	LANG_BG_WG_WORLD_ANNOUNCE_3_SEC     = 11016,
	LANG_BG_WG_WORLD_ANNOUNCE_2_SEC     = 11017,
	LANG_BG_WG_WORLD_ANNOUNCE_1_SEC     = 11018,
    ...
    LANG_NPCINFO_FLIGHT_MASTER          = 829,
    LANG_NPCINFO_SPIRIT_HEALER          = 830,
    LANG_NPCINFO_SPIRIT_GUIDE           = 831,
    LANG_NPCINFO_INNKEEPER              = 832,
    LANG_NPCINFO_BANKER                 = 833,
    LANG_NPCINFO_PETITIONER             = 834,
    LANG_NPCINFO_TABARD_DESIGNER        = 835,
    LANG_NPCINFO_BATTLE_MASTER          = 836,
    LANG_NPCINFO_AUCTIONEER             = 837,
    LANG_NPCINFO_STABLE_MASTER          = 838,
    LANG_NPCINFO_GUILD_BANKER           = 839,
    LANG_NPCINFO_SPELL_CLICK            = 840,
    LANG_NPCINFO_MAILBOX                = 841,
    LANG_NPCINFO_PLAYER_VEHICLE         = 842,

	LANG_ARENA_ERROR_NOT_FOUND          = 843,
    LANG_ARENA_ERROR_NAME_EXISTS        = 844,
    LANG_ARENA_ERROR_SIZE               = 845,
    LANG_ARENA_ERROR_COMBAT             = 846,
    LANG_AREAN_ERROR_NAME_NOT_FOUND     = 847,
    LANG_ARENA_ERROR_NOT_MEMBER         = 848,
    LANG_ARENA_ERROR_CAPTAIN            = 849,
    LANG_ARENA_CREATE                   = 850,
    LANG_ARENA_DISBAND                  = 851,
    LANG_ARENA_RENAME                   = 852,
    LANG_ARENA_CAPTAIN                  = 853,
    LANG_ARENA_INFO_HEADER              = 854,
    LANG_ARENA_INFO_MEMBERS             = 855,
    LANG_ARENA_LOOKUP                   = 856,
	...
	LANG_GUILD_INFO_NAME                = 1157,
    LANG_GUILD_INFO_GUILD_MASTER        = 1158,
    LANG_GUILD_INFO_CREATION_DATE       = 1159,
    LANG_GUILD_INFO_MEMBER_COUNT        = 1160,
    LANG_GUILD_INFO_BANK_GOLD           = 1161,
    LANG_GUILD_INFO_MOTD                = 1162,
    LANG_GUILD_INFO_EXTRA_INFO          = 1163,
    // Room for more level 3              1164-1199 not used
    ...
    // Quantum System Texts             5000-9999
    ...
    LANG_ARENA                          = 5016,
    LANG_RAID                           = 5017,
	LANG_COMMAND_TEMP_FROZEN_PLAYER     = 5018,
	                                    //= 5019,
	...
	LANG_NPCINFO_UNIT_FIELD_FLAGS       = 5037,

	// Instance commands
	LANG_COMMAND_LIST_BIND_INFO         = 5038,
	LANG_COMMAND_LIST_BIND_PLAYER_BINDS = 5039,
	LANG_COMMAND_LIST_BIND_GROUP_BINDS  = 5040,
	LANG_COMMAND_INST_UNBIND_UNBINDING  = 5041,
	LANG_COMMAND_INST_UNBIND_UNBOUND    = 5042,
	LANG_COMMAND_INST_STAT_LOADED_INST  = 5043,
	LANG_COMMAND_INST_STAT_PLAYERS_IN   = 5044,
	LANG_COMMAND_INST_STAT_SAVES        = 5045,
	LANG_COMMAND_INST_STAT_PLAYERSBOUND = 5046,
	LANG_COMMAND_INST_STAT_GROUPSBOUND  = 5047,
	LANG_NOT_DUNGEON                    = 5048, // Map is not a dungeon.
	LANG_NO_INSTANCE_DATA               = 5049, // Map has no instance data.
	LANG_COMMAND_INSTANCE_SET_FIELD     = 5050,

	// Room for more Quantum System Texts 5066-9999

	// Game Master Monitoring System
	LANG_MODERATOR_ENTER_IN_GAME           = 5051,
	LANG_EVENT_MASTER_ENTER_IN_GAME        = 5052,
	LANG_GAME_MASTER_ENTER_IN_GAME         = 5053,
	LANG_ADMINISTRATOR_ENTER_IN_GAME       = 5054,
	LANG_MAIN_ADMINISTRATOR_ENTER_IN_GAME  = 5055,
	LANG_DEVELOPER_ENTER_IN_GAME           = 5056,
	LANG_TECH_SUPPORT_ENTER_IN_GAME        = 5057,
	LANG_MODERATOR_LEAVE_IN_GAME           = 5058,
	LANG_EVENT_MASTER_LEAVE_IN_GAME        = 5059,
	LANG_GAME_MASTER_LEAVE_IN_GAME         = 5060,
	LANG_ADMINISTRATOR_LEAVE_IN_GAME       = 5061,
	LANG_MAIN_ADMINISTRATOR_LEAVE_IN_GAME  = 5062,
	LANG_DEVELOPER_LEAVE_IN_GAME           = 5063,
	LANG_TECH_SUPPORT_LEAVE_IN_GAME        = 5064,

	// Global World Messages
	LANG_NO_FLY_ZONE_WINTERGRASP           = 5065,
    ...
    LANG_GM_SILENCE                     = 6616,
	// Room for more Quantum System Texts 6617-7525
    ...
    LANG_BG_SA_WAS_DESTROYED                = 10061,
    LANG_BG_SA_ROUND_ONE_END                = 10062,
    LANG_BG_SA_ALLIANCE_CAPTURED_RELIC      = 10063,
    LANG_BG_SA_HORDE_CAPTURED_RELIC         = 10064,
    LANG_BG_SA_ROUND_TWO_ONE_MINUTE         = 10065,
    LANG_BG_SA_ROUND_TWO_START_HALF_MINUTE  = 10066,
    LANG_BG_SA_CHAMBER_BREACHED             = 10067,
    LANG_BG_SA_A_GY_SOUTH                   = 10068,
    LANG_BG_SA_A_GY_WEST                    = 10069,
    LANG_BG_SA_A_GY_EAST                    = 10070,
    LANG_BG_SA_H_GY_SOUTH                   = 10071,
    LANG_BG_SA_H_GY_WEST                    = 10072,
    LANG_BG_SA_H_GY_EAST                    = 10073,

    // Use for custom patches               11000-11999
    LANG_AUTO_BROADCAST                     = 11000,
    LANG_INVALID_REALM_ID                   = 11001,
	// Transmogrification
    ...
    LANG_SLOT_NAME_MAIN_HAND                = 11118,
    LANG_SLOT_NAME_OFF_HAND                 = 11119,
	...
	// Name Command
	LANG_MODERATOR_ANNOUNCE                 = 12000,
	LANG_EVENT_MASTER_ANNOUNCE              = 12001,
	LANG_GAME_MASTER_ANNOUNCE               = 12002,
	LANG_ADMINISTRATOR_ANNOUNCE             = 12003,
	LANG_MAIN_ADMINISTRATOR_ANNOUNCE        = 12004,
	LANG_DEVELOPER_ANNOUNCE                 = 12005,
	LANG_TECH_SUPPORT_ANNOUNCE              = 12006,
	// Ban Announce
	LANG_COMMAND_KICK_WORLD                 = 12007,
	LANG_COMMAND_MUTE_WORLD                 = 12008,
	LANG_BAN_CHARACTER_WORLD                = 12009,
	LANG_BAN_CHARACTER_PERMAMENT            = 12010,
	LANG_BAN_ACCOUNT_WORLD                  = 12011,
	LANG_BAN_ACCOUNT_PERMAMENT              = 12012,
	// npc info
	LANG_NPCINFO_INHABIT_TYPE               = 12013,
	// Antispam
	LANG_SAY_TIME_REQ                       = 13001,
	LANG_WHISPER_TIME_REQ                   = 13002,
	LANG_CHANNEL_TIME_REQ                   = 13003,
	// Vip Command
	VIP_CANT_DO                             = 13004,
	NOT_VIP                                 = 13005,
	VIP_COMMAND_DISABLED                    = 13006,
	// Fun System
	LANG_FUN_SYSTEM_RESTART                 = 13007,
	LANG_FUN_GUARD_DETECT_PLAYER_HORDE      = 13008,
	LANG_FUN_GUARD_DETECT_PLAYER_ALLIANCE   = 13009,
	// Played Time Reward
	LANG_PLAYED_TIME_REWARD_ANNOUNCE        = 13010,
	// QuantumCore Anticheat
	LANG_QUANTUM_ANTICHEAT_DETECTION        = 13011,
	// Gm Island Detect
	LANG_GM_ISLAND_HACK_DETECTION           = 13012,
	// Login Info
	LANG_LOGIN_INFO_BORDER                  = 13013,
	LANG_LOGIN_INFO_HELLO                   = 13014,
	LANG_LOGIN_INFO_PLAYER_LEVEL            = 13015,
	LANG_LOGIN_INFO_ACCOUNT_LEVEL           = 13016,
	LANG_LOGIN_INFO_PREMIUM_ACTIVE          = 13017,
	LANG_LOGIN_INFO_PREMIUM_NOT_ACTIVE      = 13018,
	LANG_LOGIN_INFO_PLAYER_IP               = 13019,
	LANG_LOGIN_INFO_TOTAL_ONLINE            = 13020,
	LANG_LOGIN_INFO_SERVER_UPTIME           = 13021,
	LANG_LOGIN_INFO_OPENED_TICKETS          = 13022,
	LANG_LOGIN_INFO_GOOD_LUCK               = 13023,
	// Guild-Level-System
	LANG_GUILD_INFO_LEVEL                   = 13024,
	LANG_GUILD_INFO_XP_INFO                 = 13025,
	// Icecrown Citadel Teleport
	TEXT_ID_TELEPORT_LIGHTS_HAMMER          = 13026,
	TEXT_ID_TELEPORT_ORATORY_THE_DAMNED     = 13027,
	TEXT_ID_TELEPORT_RAMPART_OF_SKULLS      = 13028,
	TEXT_ID_TELEPORT_DEATHBRINGERS_RISE     = 13029,
	TEXT_ID_TELEPORT_UPPER_SPIRE            = 13030,
	TEXT_ID_TELEPORT_SINDRAGOSAS_LAIR       = 13031,
	TEXT_ID_TELEPORT_FROZEN_THRONE          = 13032,
	// Ulduar Teleporter
	TEXT_ID_TELEPORT_BASE_CAMP              = 13033,
	TEXT_ID_TELEPORT_FORMATION_GROUNDS      = 13034,
	TEXT_ID_TELEPORT_COLOSSAL_FORGE         = 13035,
	TEXT_ID_TELEPORT_SCRAPYARD              = 13036,
	TEXT_ID_TELEPORT_OF_ANTECHAMBER         = 13037,
	TEXT_ID_TELEPORT_SHATTERED_WALKWAY      = 13038,
	TEXT_ID_TELEPORT_CONSERVATORY_OF_LIFE   = 13039,
	TEXT_ID_TELEPORT_HALLS_OF_WINTER        = 13040,
	TEXT_ID_TELEPORT_SPARK_OF_IMAGINATION   = 13041,
	TEXT_ID_TELEPORT_HALLS_OF_INVENTION     = 13042,
	TEXT_ID_TELEPORT_DESCENT_INTO_MADNESS   = 13043,
	// Culling of Stratholme
	TEXT_ID_ARTHAS_START_STEP_1             = 13044,
	TEXT_ID_ARTHAS_START_STEP_2             = 13045,
	TEXT_ID_ARTHAS_START_STEP_3             = 13046,
	TEXT_ID_ARTHAS_START_STEP_4             = 13047,
	TEXT_ID_ARTHAS_START_STEP_5             = 13048,
	TEXT_ID_ARTHAS_START_STEP_6             = 13049,
	// World Texts
	TEXT_ID_INNKEEPER_CREATE_HOME           = 13050,
	TEXT_ID_INNKEEPER_TRICK_OR_TREAT        = 13051,
	TEXT_ID_VENDOR_BROWSE_YOUR_GOODS        = 13052,
	TEXT_ID_TRAINER_TRAIN                   = 13053,
	// Headless Horseman
	TEXT_ID_CALL_HEADLESS_HORSEMAN          = 13054,
};
