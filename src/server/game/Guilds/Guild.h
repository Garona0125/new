...
enum GuildBonus
{
	GUILD_BONUS_GOLD_BANK_1   = 1,
	GUILD_BONUS_XP_1          = 2,
	GUILD_BONUS_FAST_SPIRIT   = 3,
	GUILD_BONUS_FOR_REPAIR_1  = 4,
	GUILD_BONUS_GOLD_BANK_2   = 5,
	GUILD_BONUS_MOUNT_SPEED_1 = 6,
	GUILD_BONUS_REPUTATION_1  = 7,
	GUILD_BONUS_XP_2          = 8,
	GUILD_BONUS_FOR_REPAIR_2  = 9,
	GUILD_BONUS_MOUNT_SPEED_2 = 10,
...
private:
    ...
    public:
        ...
        uint8 GetCurrentClass() const { return m_class; }
        uint8 GetCurrentLevel() const { return m_level; }
