...
uint32 GuildMgr::GenerateGuildId()
{
    ...
    {
		sLog->OutErrorConsole("Guild ids overflow!! Can't continue, shutting down server.");
...
{
    // 1. Load all guilds
	sLog->OutConsole("QUANTUMCORE SERVER: Loading Guilds Definitions...");
    {
        ...
        {
			sLog->OutConsole("=========================================================");
            sLog->OutConsole(">> Loaded 0 guild definitions. DB table `guild` is empty!");
			sLog->OutConsole("=========================================================");
			sLog->OutConsole();
            return;
        }
        else
        {
			...
			sLog->OutConsole("=========================================");
			sLog->OutConsole(">> Loaded %u guild definitions in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
			sLog->OutConsole("=========================================");
			sLog->OutConsole();
        }
    }
	...
	sLog->OutConsole("QUANTUMCORE SERVER: Loading Guild Ranks...");
    {
        uint32 oldMSTime = getMSTime();
        ...
        {
			sLog->OutConsole("========================================================");
			sLog->OutConsole(">> Loaded 0 guild ranks. DB table `guild_rank` is empty!");
			sLog->OutConsole("========================================================");
			sLog->OutConsole();
        }
        else
        {
			...
			sLog->OutConsole("===================================");
			sLog->OutConsole(">> Loaded %u guild ranks in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
			sLog->OutConsole("===================================");
			sLog->OutConsole();
        }
    }
	...
	sLog->OutConsole("QUANTUMCORE SERVER: Loading Guild Members...");
    {
        uint32 oldMSTime = getMSTime();
		...
		{
			sLog->OutConsole("============================================================");
			sLog->OutConsole(">> Loaded 0 guild members. DB table `guild_member` is empty!");
			sLog->OutConsole("============================================================");
			sLog->OutConsole();
		}
        else
        {
			...
			sLog->OutConsole("======================================");
			sLog->OutConsole(">> Loaded %u guild members int %u ms", count, GetMSTimeDiffToNow(oldMSTime));
			sLog->OutConsole("======================================");
			sLog->OutConsole();
        }
    }
    ...
    sLog->OutConsole("QUANTUMCORE SERVER: Loading Bank Tab Rights...");
    {
        uint32 oldMSTime = getMSTime();
        ...
        {
			sLog->OutConsole("========================================================================");
			sLog->OutConsole(">> Loaded 0 guild bank tab rights. DB table `guild_bank_right` is empty!");
			sLog->OutConsole("========================================================================");
			sLog->OutConsole();
        }
        else
        {
			...
			sLog->OutConsole("=======================================");
			sLog->OutConsole(">> Loaded %u bank tab rights in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
			sLog->OutConsole("=======================================");
			sLog->OutConsole();
        }
    }
	...
	sLog->OutConsole("QUANTUMCORE SERVER: Loading Guild Event Logs...");
    {
        uint32 oldMSTime = getMSTime();
        ...
        {
			sLog->OutConsole("=================================================================");
			sLog->OutConsole(">> Loaded 0 guild event logs. DB table `guild_eventlog` is empty!");
			sLog->OutConsole("=================================================================");
			sLog->OutConsole();
        }
        else
        {
			...
			sLog->OutConsole("========================================");
			sLog->OutConsole(">> Loaded %u guild event logs in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
			sLog->OutConsole("========================================");
			sLog->OutConsole();
        }
    }
	...
	sLog->OutConsole("QUANTUMCORE SERVER: Loading Guild Bank Event Logs...");
    {
        uint32 oldMSTime = getMSTime();
        ...
        {
			sLog->OutConsole("===========================================================================");
			sLog->OutConsole(">> Loaded 0 guild bank event logs. DB table `guild_bank_eventlog` is empty!");
			sLog->OutConsole("===========================================================================");
			sLog->OutConsole();
        }
        else
        {
			...
			sLog->OutConsole("=============================================");
			sLog->OutConsole(">> Loaded %u guild bank event logs in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
			sLog->OutConsole("=============================================");
			sLog->OutConsole();
        }
    }
	...
	sLog->OutConsole("QUANTUMCORE SERVER: Loading Guild Bank Tabs...");
    {
        uint32 oldMSTime = getMSTime();
        ...
        {
			sLog->OutConsole("================================================================");
			sLog->OutConsole(">> Loaded 0 guild bank tabs. DB table `guild_bank_tab` is empty!");
			sLog->OutConsole("================================================================");
			sLog->OutConsole();
        }
        else
        {
			...
			sLog->OutConsole("=======================================");
			sLog->OutConsole(">> Loaded %u guild bank tabs in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
			sLog->OutConsole("=======================================");
			sLog->OutConsole();
        }
    }
	...
	sLog->OutConsole("Filling bank tabs with items...");
    {
        uint32 oldMSTime = getMSTime();
        ...
        {
			sLog->OutConsole("=========================================================================================");
			sLog->OutConsole(">> Loaded 0 guild bank tab items. DB table `guild_bank_item` or `item_instance` is empty!");
			sLog->OutConsole("=========================================================================================");
			sLog->OutConsole();
        }
        else
        {
			...
			sLog->OutConsole("============================================");
			sLog->OutConsole(">> Loaded %u guild bank tab items in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
			sLog->OutConsole("============================================");
			sLog->OutConsole();
        }
    }
	...
	sLog->OutConsole("Validating data of loaded guilds...");
    {
        uint32 oldMSTime = getMSTime();
		...
		sLog->OutConsole("=============================================");
		sLog->OutConsole(">> Validated data of loaded guilds in %u ms", GetMSTimeDiffToNow(oldMSTime));
		sLog->OutConsole("=============================================");
		sLog->OutConsole();
    }
}
