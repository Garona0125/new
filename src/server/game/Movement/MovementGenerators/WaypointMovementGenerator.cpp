...
void WaypointMovementGenerator<Creature>::LoadPath(Creature &creature)
{
    ...
    if (!i_path)
    {
		...
		sLog->OutErrorDatabase("WaypointMovementGenerator::LoadPath: creature %s (Entry: %u GUID: %u DB GUID: %u) doesn't have waypoint path id: %u", creature.GetName(), creature.GetEntry(), creature.GetGUIDLow(), creature.GetDBTableGUIDLow(), path_id);
        return;
    }
