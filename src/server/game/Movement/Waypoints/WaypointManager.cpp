...
void WaypointMgr::Load()
{
    ...
    {
		sLog->OutConsole("=========================================================");
        sLog->OutConsole(">> Loaded 0 waypoints. DB table `waypoint_data` is empty!");
		sLog->OutConsole("=========================================================");
        sLog->OutConsole();
        return;
    }
    ...
    do
    {
		...
		{
			sLog->OutErrorConsole("Waypoint %u in waypoint_data has invalid move_type, ignoring", wp->id);
			delete wp;
			continue;
		}
	...
	sLog->OutConsole("=================================");
    sLog->OutConsole(">> Loaded %u waypoints in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
	sLog->OutConsole("=================================");
    sLog->OutConsole();
}
