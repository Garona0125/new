...
namespace Movement
{
    ...
    void MoveSplineInit::Launch()
    {
        ...
        if (unit.HasUnitMovementFlag(MOVEMENTFLAG_ON_TRANSPORT) && unit.GetTransGUID())
        {
            transport = true;
    ...
    {
        // Elevators also use MOVEMENTFLAG_ONTRANSPORT but we do not keep track of their position changes
        args.TransformForTransport = unit.HasUnitMovementFlag(MOVEMENTFLAG_ON_TRANSPORT) && unit.GetTransGUID();
