...
{
    public:
        WorldSession(uint32 id, WorldSocket* sock, AccountTypes sec, uint8 expansion, bool IsPremiumAccount, time_t mute_time, LocaleConstant locale, uint32 recruiter, bool isARecruiter);
        ~WorldSession();
		...
		bool IsPremiumAccount() const { return _ispremium; }
        ...
        const char *GetQuantumSystemText(int32 entry) const;
