...
enum GroupMemberFlags
{
    ...
    MEMBER_FLAG_MAIN_TANK   = 0x02,
    MEMBER_FLAG_MAIN_ASSIST = 0x04,
};

enum GroupMemberAssignment
{
    GROUP_ASSIGN_MAIN_TANK   = 0,
    GROUP_ASSIGN_MAIN_ASSIST = 1,
};
...
enum GroupType
{
	...
	GROUP_TYPE_LFG_RESTRICTED = 0x04, // Script_HasLFGRestrictions()
	GROUP_TYPE_LFG            = 0x08,
