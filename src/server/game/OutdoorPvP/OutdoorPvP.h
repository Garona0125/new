...
{
    OBJECTIVE_STATE_NEUTRAL = 0,
    OBJECTIVE_STATE_ALLIANCE,
    OBJECTIVE_STATE_HORDE,
    OBJECTIVE_STATE_NEUTRAL_ALLIANCE_CHALLENGE,
    OBJECTIVE_STATE_NEUTRAL_HORDE_CHALLENGE,
    OBJECTIVE_STATE_ALLIANCE_HORDE_CHALLENGE,
    OBJECTIVE_STATE_HORDE_ALLIANCE_CHALLENGE,
};
