...
bool AchievementCriteriaData::IsValid(AchievementCriteriaEntry const* criteria)
{
    ...
    {
        sLog->OutErrorDatabase("Table `achievement_criteria_data` for criteria (Entry: %u) has wrong data type (%u), ignored.", criteria->ID, dataType);
        return false;
    }
    ...
    switch (criteria->requiredType)
    {
        ...
        case ACHIEVEMENT_CRITERIA_TYPE_BE_SPELL_TARGET_2:
        ...
        default:
            ...
            {
                sLog->OutErrorDatabase("Table `achievement_criteria_data` has data for non-supported criteria type (Entry: %u Type: %u), ignored.", criteria->ID, criteria->requiredType);
                return false;
            }
            break;
    }
    ...
    switch (dataType)
    {
        ...
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_CREATURE:
            ...
            {
                sLog->OutErrorDatabase("Table `achievement_criteria_data` (Entry: %u Type: %u) for data type ACHIEVEMENT_CRITERIA_DATA_TYPE_CREATURE (%u) has non-existing creature id in value1 (%u), ignored.",
        ...
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_PLAYER_CLASS_RACE:
            ...
            {
                sLog->OutErrorDatabase("Table `achievement_criteria_data` (Entry: %u Type: %u) for data type ACHIEVEMENT_CRITERIA_DATA_TYPE_T_PLAYER_CLASS_RACE (%u) has non-existing class in value1 (%u), ignored.",
                    criteria->ID, criteria->requiredType, dataType, classRace.class_id);
                return false;
            }
            if (classRace.race_id && ((1 << (classRace.race_id-1)) & RACEMASK_ALL_PLAYABLE) == 0)
            {
                sLog->OutErrorDatabase("Table `achievement_criteria_data` (Entry: %u Type: %u) for data type ACHIEVEMENT_CRITERIA_DATA_TYPE_T_PLAYER_CLASS_RACE (%u) has non-existing race in value2 (%u), ignored.",
        ...
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_PLAYER_LESS_HEALTH:
            ...
            {
                sLog->OutErrorDatabase("Table `achievement_criteria_data` (Entry: %u Type: %u) for data type ACHIEVEMENT_CRITERIA_DATA_TYPE_PLAYER_LESS_HEALTH (%u) has wrong percent value in value1 (%u), ignored.",
        ...
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_PLAYER_DEAD:
            ...
            {
                sLog->OutErrorDatabase("Table `achievement_criteria_data` (Entry: %u Type: %u) for data type ACHIEVEMENT_CRITERIA_DATA_TYPE_T_PLAYER_DEAD (%u) has wrong boolean value1 (%u).",
        ...
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_AURA:
        {
            ...
            if (!spellEntry)
            {
                sLog->OutErrorDatabase("Table `achievement_criteria_data` (Entry: %u Type: %u) for data type %s (%u) has wrong spell id in value1 (%u), ignored.",
            ...
            {
                sLog->OutErrorDatabase("Table `achievement_criteria_data` (Entry: %u Type: %u) for data type %s (%u) has wrong spell effect index in value2 (%u), ignored.",
            ...
            {
                sLog->OutErrorDatabase("Table `achievement_criteria_data` (Entry: %u Type: %u) for data type %s (%u) has non-aura spell effect (ID: %u Effect: %u), ignores.",
        ...
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_S_AREA:
            ...
            {
                sLog->OutErrorDatabase("Table `achievement_criteria_data` (Entry: %u Type: %u) for data type ACHIEVEMENT_CRITERIA_DATA_TYPE_S_AREA (%u) has wrong area id in value1 (%u), ignored.",
		...
		case ACHIEVEMENT_CRITERIA_DATA_TYPE_VALUE:
			...
			{
				sLog->OutErrorDatabase("Table `achievement_criteria_data` (Entry: %u Type: %u) for data type ACHIEVEMENT_CRITERIA_DATA_TYPE_VALUE (%u) has wrong ComparisionType in value2 (%u), ignored.",
        ...
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_LEVEL:
            ...
            {
                sLog->OutErrorDatabase("Table `achievement_criteria_data` (Entry: %u Type: %u) for data type ACHIEVEMENT_CRITERIA_DATA_TYPE_T_LEVEL (%u) has wrong minlevel in value1 (%u), ignored.",
        ...
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_GENDER:
            ...
            {
                sLog->OutErrorDatabase("Table `achievement_criteria_data` (Entry: %u Type: %u) for data type ACHIEVEMENT_CRITERIA_DATA_TYPE_T_GENDER (%u) has wrong gender in value1 (%u), ignored.",
        ...
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_SCRIPT:
            if (!ScriptId)
            {
                sLog->OutErrorDatabase("Table `achievement_criteria_data` (Entry: %u Type: %u) for data type ACHIEVEMENT_CRITERIA_DATA_TYPE_SCRIPT (%u) does not have ScriptName set, ignored.",
        ...
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_MAP_DIFFICULTY:
            ...
            {
                sLog->OutErrorDatabase("Table `achievement_criteria_data` (Entry: %u Type: %u) for data type ACHIEVEMENT_CRITERIA_DATA_TYPE_MAP_DIFFICULTY (%u) has wrong difficulty in value1 (%u), ignored.",
        ...
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_MAP_PLAYER_COUNT:
            ...
            {
                sLog->OutErrorDatabase("Table `achievement_criteria_data` (Entry: %u Type: %u) for data type ACHIEVEMENT_CRITERIA_DATA_TYPE_MAP_PLAYER_COUNT (%u) has wrong max players count in value1 (%u), ignored.",
        ...
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_TEAM:
            ...
            {
                sLog->OutErrorDatabase("Table `achievement_criteria_data` (Entry: %u Type: %u) for data type ACHIEVEMENT_CRITERIA_DATA_TYPE_T_TEAM (%u) has unknown team in value1 (%u), ignored.",
        ...
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_S_DRUNK:
            ...
            {
                sLog->OutErrorDatabase("Table `achievement_criteria_data` (Entry: %u Type: %u) for data type ACHIEVEMENT_CRITERIA_DATA_TYPE_S_DRUNK (%u) has unknown drunken state in value1 (%u), ignored.",
        ...
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_HOLIDAY:
            ...
            {
                sLog->OutErrorDatabase("Table `achievement_criteria_data` (Entry: %u Type: %u) for data type ACHIEVEMENT_CRITERIA_DATA_TYPE_HOLIDAY (%u) has unknown holiday in value1 (%u), ignored.",
        ...
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_S_EQUIPED_ITEM:
            ...
            {
                sLog->OutErrorDatabase("Table `achievement_criteria_requirement` (Entry: %u Type: %u) for requirement ACHIEVEMENT_CRITERIA_REQUIRE_S_EQUIPED_ITEM (%u) has unknown quality state in value1 (%u), ignored.",
        ...
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_MAP_ID:
            ...
            {
                sLog->OutErrorDatabase("Table `achievement_criteria_requirement` (Entry: %u Type: %u) for requirement ACHIEVEMENT_CRITERIA_DATA_TYPE_MAP_ID (%u) has unknown map id in value1 (%u), ignored.",
        ...
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_S_PLAYER_CLASS_RACE:
            ...
            {
                sLog->OutErrorDatabase("Table `achievement_criteria_data` (Entry: %u Type: %u) for data type ACHIEVEMENT_CRITERIA_DATA_TYPE_S_PLAYER_CLASS_RACE (%u) must not have 0 in either value field, ignored.",
                    criteria->ID, criteria->requiredType, dataType);
                return false;
            }
            if (classRace.class_id && ((1 << (classRace.class_id-1)) & CLASSMASK_ALL_PLAYABLE) == 0)
            {
                sLog->OutErrorDatabase("Table `achievement_criteria_data` (Entry: %u Type: %u) for data type ACHIEVEMENT_CRITERIA_DATA_TYPE_S_PLAYER_CLASS_RACE (%u) has non-existing class in value1 (%u), ignored.",
                    criteria->ID, criteria->requiredType, dataType, classRace.class_id);
                return false;
            }
            if (classRace.race_id && ((1 << (classRace.race_id-1)) & RACEMASK_ALL_PLAYABLE) == 0)
            {
                sLog->OutErrorDatabase("Table `achievement_criteria_data` (Entry: %u Type: %u) for data type ACHIEVEMENT_CRITERIA_DATA_TYPE_S_PLAYER_CLASS_RACE (%u) has non-existing race in value2 (%u), ignored.",
                    criteria->ID, criteria->requiredType, dataType, classRace.race_id);
                return false;
            }
            return true;
		case ACHIEVEMENT_CRITERIA_REQUIRE_KNOWN_TITLE:
		{
			...
			{
				sLog->OutErrorDatabase("Table `achievement_criteria_data` (Entry: %u Type: %u) for data type ACHIEVEMENT_CRITERIA_DATA_TYPE_S_KNOWN_TITLE (%u) have unknown title_id in value1 (%u), ignore.",
        ...
        default:
            sLog->OutErrorDatabase("Table `achievement_criteria_data` (Entry: %u Type: %u) has data for non-supported data type (%u), ignored.", criteria->ID, criteria->requiredType, dataType);
            return false;
    }
}
    ...
    switch (dataType)
    {
        ...
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_PLAYER_CLASS_RACE:
            if (!target || target->GetTypeId() != TYPE_ID_PLAYER)
                return false;
            if (classRace.class_id && classRace.class_id != target->ToPlayer()->GetCurrentClass())
                return false;
            if (classRace.race_id && classRace.race_id != target->ToPlayer()->GetCurrentRace())
                return false;
            return true;
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_S_PLAYER_CLASS_RACE:
            if (!source || source->GetTypeId() != TYPE_ID_PLAYER)
                return false;
            if (classRace.class_id && classRace.class_id != source->ToPlayer()->GetCurrentClass())
                return false;
            if (classRace.race_id && classRace.race_id != source->ToPlayer()->GetCurrentRace())
                return false;
            return true;
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_PLAYER_LESS_HEALTH:
            if (!target || target->GetTypeId() != TYPE_ID_PLAYER)
        ...
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_LEVEL:
            if (!target)
                return false;
            return target->GetCurrentLevel() >= level.minlevel;
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_GENDER:
            if (!target)
                return false;
            return target->GetCurrentGender() == gender.gender;
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_SCRIPT:
        ...
        case ACHIEVEMENT_CRITERIA_DATA_INSTANCE_SCRIPT:
        {
            ...
            if (!map->IsDungeon())
            {
                sLog->OutErrorDatabase("Achievement system call ACHIEVEMENT_CRITERIA_DATA_INSTANCE_SCRIPT (%u) for achievement criteria %u for non-dungeon/non-raid map %u",
            ...
            if (!instance)
            {
                sLog->OutErrorDatabase("Achievement system call ACHIEVEMENT_CRITERIA_DATA_INSTANCE_SCRIPT (%u) for achievement criteria %u for map %u but map does not have a instance script",
                    ACHIEVEMENT_CRITERIA_DATA_INSTANCE_SCRIPT, criteria_id, map->GetId());
                return false;
            }
    ...
    if (achievementResult)
    {
        do
        {
            ...
            if (AchievementReward const* reward = sAchievementMgr->GetAchievementReward(achievement))
                if (uint32 titleId = reward->titleId[Player::TeamForRace(GetPlayer()->GetCurrentRace()) == ALLIANCE ? 0 : 1])
    ...
    if (criteriaResult)
    {
        do
        {
            ...
            if (!criteria)
            {
                ...
                sLog->OutErrorConsole("Non-existing achievement criteria %u data removed from table `character_achievement_progress`.", id);
            ...
            case ACHIEVEMENT_CRITERIA_TYPE_REACH_LEVEL:
                if (AchievementCriteriaDataSet const* data = sAchievementMgr->GetCriteriaDataSet(achievementCriteria))
                    if (!data->Meets(GetPlayer(), unit))
                        continue;
                SetCriteriaProgress(achievementCriteria, GetPlayer()->GetCurrentLevel());
                break;
...
void AchievementMgr::CompletedAchievement(AchievementEntry const* achievement)
{
    ...
    if (uint32 titleId = reward->titleId[achievement->ID == 1793 ? GetPlayer()->GetCurrentGender() : (GetPlayer()->GetTeam() == ALLIANCE ? 0 : 1)])
        if (CharTitlesEntry const* titleEntry = sCharTitlesStore.LookupEntry(titleId))
            GetPlayer()->SetTitle(titleEntry);
...
void AchievementGlobalMgr::LoadAchievementCriteriaList()
{
    ...
    {
		sLog->OutConsole("================================================================================");
        sLog->OutConsole(">> Loaded 0 achievement criteria. DB table `achievement_criteria_data` is empty!");
		sLog->OutConsole("================================================================================");
        sLog->OutConsole();
        return;
    }
	...
	sLog->OutConsole("=============================================");
    sLog->OutConsole(">> Loaded %lu achievement criteria in %u ms", (unsigned long)m_AchievementCriteriasByType->size(), GetMSTimeDiffToNow(oldMSTime));
	sLog->OutConsole("=============================================");
    sLog->OutConsole();
}
...
void AchievementGlobalMgr::LoadAchievementReferenceList()
{
    ...
    {
		sLog->OutConsole("===================================");
        sLog->OutConsole(">> Loaded 0 achievement references.");
		sLog->OutConsole("===================================");
        sLog->OutConsole();
        return;
    }
	...
	sLog->OutConsole("==============================================");
    sLog->OutConsole(">> Loaded %u achievement references in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
	sLog->OutConsole("==============================================");
    sLog->OutConsole();
}
...
void AchievementGlobalMgr::LoadAchievementCriteriaData()
{
    ...
    {
		sLog->OutConsole("================================================================================================");
        sLog->OutConsole(">> Loaded 0 additional achievement criteria data. DB table `achievement_criteria_data` is empty!");
		sLog->OutConsole("================================================================================================");
        sLog->OutConsole();
        return;
    }
    ...
    do
    {
        ...
        if (!criteria)
        {
            sLog->OutErrorDatabase("Table `achievement_criteria_data` has data for non-existing criteria (Entry: %u), ignore.", criteria_id);
            continue;
        }
        ...
        {
            if (dataType != ACHIEVEMENT_CRITERIA_DATA_TYPE_SCRIPT)
                sLog->OutErrorDatabase("Table `achievement_criteria_data` has ScriptName set for non-scripted data type (Entry: %u, type %u), useless data.", criteria_id, dataType);
            else
    ...
    for (uint32 entryId = 0; entryId < sAchievementCriteriaStore.GetNumRows(); ++entryId)
    {
        ...
        if (!GetCriteriaDataSet(criteria) && !DisableMgr::IsDisabledFor(DISABLE_TYPE_ACHIEVEMENT_CRITERIA, entryId, NULL))
            sLog->OutErrorDatabase("Table `achievement_criteria_data` does not have expected data for criteria (Entry: %u Type: %u) for achievement %u.", criteria->ID, criteria->requiredType, criteria->referredAchievement);
    }

	sLog->OutConsole("============================================================");
    sLog->OutConsole(">> Loaded %u additional achievement criteria data in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
	sLog->OutConsole("============================================================");
    sLog->OutConsole();
}
...
void AchievementGlobalMgr::LoadCompletedAchievements()
{
    ...
    {
		sLog->OutConsole("==============================================================================");
        sLog->OutConsole(">> Loaded 0 completed achievements. DB table `character_achievement` is empty!");
		sLog->OutConsole("==============================================================================");
        sLog->OutConsole();
        return;
    }
    ...
    do
    {
        ...
        if (!achievement)
        {
            ...
            sLog->OutErrorConsole("Non-existing achievement %u data removed from table `character_achievement`.", achievementId);
	...
	sLog->OutConsole("===============================================");
	sLog->OutConsole(">> Loaded %lu completed achievements in %u ms", (unsigned long)m_allCompletedAchievements.size(), GetMSTimeDiffToNow(oldMSTime));
	sLog->OutConsole("===============================================");
    sLog->OutConsole();
}
...
void AchievementGlobalMgr::LoadRewards()
{
    ...
    {
		sLog->OutConsole("========================================================================");
		sLog->OutConsole(">> Loaded 0 achievement rewards. DB table `achievement_reward` is empty!");
		sLog->OutConsole("========================================================================");
        return;
    }
    ...
    do
    {
        ...
        if (!achievement)
        {
			sLog->OutErrorDatabase("Table `achievement_reward` has wrong achievement (Entry: %u), ignore", entry);
            continue;
        }
        ...
        {
            sLog->OutErrorDatabase("Table `achievement_reward` (Entry: %u) does not have title or item reward data, ignored.", entry);
            continue;
        }

        if (achievement->requiredFaction == ACHIEVEMENT_FACTION_ANY && (!reward.titleId[0] ^ !reward.titleId[1]))
            sLog->OutErrorDatabase("Table `achievement_reward` (Entry: %u) has title (A: %u H: %u) for only one team.", entry, reward.titleId[0], reward.titleId[1]);
        ...
        if (reward.titleId[0])
        {
            ...
            if (!titleEntry)
            {
                sLog->OutErrorDatabase("Table `achievement_reward` (Entry: %u) has invalid title id (%u) in `title_A`, set to 0", entry, reward.titleId[0]);
                reward.titleId[0] = 0;
            }
        }
        ...
        if (reward.titleId[1])
        {
            ...
            if (!titleEntry)
            {
                sLog->OutErrorDatabase("Table `achievement_reward` (Entry: %u) has invalid title id (%u) in `title_H`, set to 0", entry, reward.titleId[1]);
                reward.titleId[1] = 0;
            }
        }
        ...
        if (reward.sender)
        {
            ...
            {
                sLog->OutErrorDatabase("Table `achievement_reward` (Entry: %u) has invalid creature entry %u as sender, mail reward skipped.", entry, reward.sender);
                reward.sender = 0;
            }
        }
        else
        {
            if (reward.itemId)
                sLog->OutErrorDatabase("Table `achievement_reward` (Entry: %u) does not have sender data but has item reward, item will not be rewarded.", entry);

            if (!reward.subject.empty())
                sLog->OutErrorDatabase("Table `achievement_reward` (Entry: %u) does not have sender data but has mail subject.", entry);

            if (!reward.text.empty())
                sLog->OutErrorDatabase("Table `achievement_reward` (Entry: %u) does not have sender data but has mail text.", entry);

            if (reward.mailTemplate)
                sLog->OutErrorDatabase("Table `achievement_reward` (Entry: %u) does not have sender data but has mailTemplate.", entry);
        }
        ...
        if (reward.mailTemplate)
        {
            ...
            {
                sLog->OutErrorDatabase("Table `achievement_reward` (Entry: %u) has invalid mailTemplate (%u).", entry, reward.mailTemplate);
                reward.mailTemplate = 0;
            }
            else if (!reward.subject.empty() || !reward.text.empty())
                sLog->OutErrorDatabase("Table `achievement_reward` (Entry: %u) has mailTemplate (%u) and mail subject/text.", entry, reward.mailTemplate);
        }
        ...
        if (reward.itemId)
        {
            ...
            {
                sLog->OutErrorDatabase("Table `achievement_reward` (Entry: %u) has invalid item id %u, reward mail will not contain item.", entry, reward.itemId);
                reward.itemId = 0;
            }
        }
	...
	sLog->OutConsole("===========================================");
	sLog->OutConsole(">> Loaded %u achievement rewards in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
	sLog->OutConsole("===========================================");
	sLog->OutConsole();
}
...
void AchievementGlobalMgr::LoadRewardLocales()
{
    ...
    {
		sLog->OutConsole("==============================================================================================");
        sLog->OutConsole(">> Loaded 0 achievement reward locale strings. DB table `locales_achievement_reward` is empty!");
		sLog->OutConsole("==============================================================================================");
        sLog->OutConsole();
        return;
    }
    ...
    do
    {
        ...
        {
            sLog->OutErrorDatabase("Table `locales_achievement_reward` (Entry: %u) has locale strings for non-existing achievement reward.", entry);
            continue;
        }
	...
	sLog->OutConsole("==========================================================");
    sLog->OutConsole(">> Loaded %lu achievement reward locale strings in %u ms", (unsigned long)m_achievementRewardLocales.size(), GetMSTimeDiffToNow(oldMSTime));
	sLog->OutConsole("==========================================================");
    sLog->OutConsole();
}
