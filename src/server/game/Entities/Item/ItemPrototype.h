...
enum ItemFieldFlags
{
    ...
    ITEM_FLAG_PVP_REWARD    = 0x00000400, // PVP Reward Flag
...
enum InventoryType
{
    ...
    INVENTORY_TYPE_2H_WEAPON                    = 17,
    INVENTORY_TYPE_BAG                          = 18,
    INVENTORY_TYPE_TABARD                       = 19,
    INVENTORY_TYPE_ROBE                         = 20,
    INVENTORY_TYPE_WEAPON_MAIN_HAND             = 21,
    INVENTORY_TYPE_WEAPON_OFF_HAND              = 22,
