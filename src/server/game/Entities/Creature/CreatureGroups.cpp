...
void FormationMgr::LoadCreatureFormations()
{
    ...
    {
		sLog->OutConsole("=============================================================================");
        sLog->OutConsole(">> Loaded 0 creatures in formations. DB table `creature_formations` is empty!");
		sLog->OutConsole("=============================================================================");
        sLog->OutConsole();
        return;
    }
    ...
    do
    {
        ...
        // check data correctness
        {
            ...
            {
                sLog->OutErrorDatabase("creature_formations table leader guid %u incorrect (not exist)", group_member->leaderGUID);
                delete group_member;
                continue;
            }
            ...
            {
                sLog->OutErrorDatabase("creature_formations table member guid %u incorrect (not exist)", memberGUID);
                delete group_member;
                continue;
            }
        }
	...
	sLog->OutConsole("===============================================");
    sLog->OutConsole(">> Loaded %u creatures in formations in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
	sLog->OutConsole("===============================================");
    sLog->OutConsole();
}
