...
#define CREATURE_FLAG_EXTRA_DB_ALLOWED (CREATURE_FLAG_EXTRA_INSTANCE_BIND | CREATURE_FLAG_EXTRA_CIVILIAN | \
    ...
    CREATURE_FLAG_EXTRA_GUARD | CREATURE_FLAG_EXTRA_RESPAWN_IGNORE | CREATURE_FLAG_EXTRA_IGNORE_PATHFINDING | CREATURE_FLAG_EXTRA_NO_PULL_BY_GRIP)
...
class Creature : public Unit, public GridObject<Creature>, public MapCreature
{
    public:
        ...
        uint8 GetCurrentLevelForTarget(WorldObject const* target) const; // overwrite Unit::GetCurrentLevelForTarget for boss level support
        ...
        {
            return (GetCurrentLevel()/2 + uint32(GetStat(STAT_STRENGTH)/20));
        }
        ...
        void DespawnAfterAction(uint32 msTimeToDespawn = 0);
