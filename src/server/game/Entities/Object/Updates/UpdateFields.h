...
enum EUnitFields
{
    ...
    UNIT_FIELD_CHARMED_BY                     = OBJECT_END + 0x0006, // Size: 2, Type: LONG, Flags: PUBLIC
    UNIT_FIELD_SUMMONED_BY                    = OBJECT_END + 0x0008, // Size: 2, Type: LONG, Flags: PUBLIC
    UNIT_FIELD_CREATED_BY                     = OBJECT_END + 0x000A, // Size: 2, Type: LONG, Flags: PUBLIC
    ...
    UNIT_FIELD_POWER_1                        = OBJECT_END + 0x0013, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_POWER_2                        = OBJECT_END + 0x0014, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_POWER_3                        = OBJECT_END + 0x0015, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_POWER_4                        = OBJECT_END + 0x0016, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_POWER_5                        = OBJECT_END + 0x0017, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_POWER_6                        = OBJECT_END + 0x0018, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_POWER_7                        = OBJECT_END + 0x0019, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_MAX_HEALTH                     = OBJECT_END + 0x001A, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_MAX_POWER_1                    = OBJECT_END + 0x001B, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_MAX_POWER_2                    = OBJECT_END + 0x001C, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_MAX_POWER_3                    = OBJECT_END + 0x001D, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_MAX_POWER_4                    = OBJECT_END + 0x001E, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_MAX_POWER_5                    = OBJECT_END + 0x001F, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_MAX_POWER_6                    = OBJECT_END + 0x0020, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_MAX_POWER_7                    = OBJECT_END + 0x0021, // Size: 1, Type: INT, Flags: PUBLIC
    ...
    UNIT_FIELD_FACTION_TEMPLATE               = OBJECT_END + 0x0031, // Size: 1, Type: INT, Flags: PUBLIC
    ...
    UNIT_FIELD_AURA_STATE                     = OBJECT_END + 0x0037, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_BASE_ATTACK_TIME               = OBJECT_END + 0x0038, // Size: 2, Type: INT, Flags: PUBLIC
    UNIT_FIELD_RANGED_ATTACK_TIME             = OBJECT_END + 0x003A, // Size: 1, Type: INT, Flags: PRIVATE
    ...
    UNIT_FIELD_DISPLAY_ID                     = OBJECT_END + 0x003D, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_NATIVE_DISPLAY_ID              = OBJECT_END + 0x003E, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_MOUNT_DISPLAY_ID               = OBJECT_END + 0x003F, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_MIN_DAMAGE                     = OBJECT_END + 0x0040, // Size: 1, Type: FLOAT, Flags: PRIVATE, OWNER, PARTY_LEADER
    UNIT_FIELD_MAX_DAMAGE                     = OBJECT_END + 0x0041, // Size: 1, Type: FLOAT, Flags: PRIVATE, OWNER, PARTY_LEADER
    UNIT_FIELD_MIN_OFF_HAND_DAMAGE            = OBJECT_END + 0x0042, // Size: 1, Type: FLOAT, Flags: PRIVATE, OWNER, PARTY_LEADER
    UNIT_FIELD_MAX_OFF_HAND_DAMAGE            = OBJECT_END + 0x0043, // Size: 1, Type: FLOAT, Flags: PRIVATE, OWNER, PARTY_LEADER
    UNIT_FIELD_BYTES_1                        = OBJECT_END + 0x0044, // Size: 1, Type: BYTES, Flags: PUBLIC
    UNIT_FIELD_PET_NUMBER                     = OBJECT_END + 0x0045, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_PET_NAME_TIME_STAMP            = OBJECT_END + 0x0046, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_PET_EXPERIENCE                 = OBJECT_END + 0x0047, // Size: 1, Type: INT, Flags: OWNER
    UNIT_FIELD_PET_NEXT_LEVEL_EXP             = OBJECT_END + 0x0048, // Size: 1, Type: INT, Flags: OWNER
    ...
    UNIT_NPC_EMOTE_STATE                      = OBJECT_END + 0x004D, // Size: 1, Type: INT, Flags: PUBLIC
    ...
    UNIT_FIELD_POS_STAT_0                     = OBJECT_END + 0x0053, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
    UNIT_FIELD_POS_STAT_1                     = OBJECT_END + 0x0054, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
    UNIT_FIELD_POS_STAT_2                     = OBJECT_END + 0x0055, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
    UNIT_FIELD_POS_STAT_3                     = OBJECT_END + 0x0056, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
    UNIT_FIELD_POS_STAT_4                     = OBJECT_END + 0x0057, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
    UNIT_FIELD_NEG_STAT_0                     = OBJECT_END + 0x0058, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
    UNIT_FIELD_NEG_STAT_1                     = OBJECT_END + 0x0059, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
    UNIT_FIELD_NEG_STAT_2                     = OBJECT_END + 0x005A, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
    UNIT_FIELD_NEG_STAT_3                     = OBJECT_END + 0x005B, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
    UNIT_FIELD_NEG_STAT_4                     = OBJECT_END + 0x005C, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
    ...
    UNIT_FIELD_MIN_RANGED_DAMAGE              = OBJECT_END + 0x007B, // Size: 1, Type: FLOAT, Flags: PRIVATE, OWNER
    UNIT_FIELD_MAX_RANGED_DAMAGE              = OBJECT_END + 0x007C, // Size: 1, Type: FLOAT, Flags: PRIVATE, OWNER
    ...
    UNIT_FIELD_MAX_HEALTH_MODIFIER            = OBJECT_END + 0x008B, // Size: 1, Type: FLOAT, Flags: PRIVATE, OWNER
    UNIT_FIELD_HOVER_HEIGHT                   = OBJECT_END + 0x008C, // Size: 1, Type: FLOAT, Flags: PUBLIC
    UNIT_FIELD_PADDING                        = OBJECT_END + 0x008D, // Size: 1, Type: INT, Flags: NONE
    UNIT_END                                  = OBJECT_END + 0x008E,

    PLAYER_DUEL_ARBITER                       = UNIT_END + 0x0000, // Size: 2, Type: LONG, Flags: PUBLIC
    PLAYER_FLAGS                              = UNIT_END + 0x0002, // Size: 1, Type: INT, Flags: PUBLIC
    PLAYER_GUILD_ID                           = UNIT_END + 0x0003, // Size: 1, Type: INT, Flags: PUBLIC
    PLAYER_GUILD_RANK                         = UNIT_END + 0x0004, // Size: 1, Type: INT, Flags: PUBLIC
    ...
    PLAYER_GUILD_TIME_STAMP                   = UNIT_END + 0x0009, // Size: 1, Type: INT, Flags: PUBLIC
    ...
    PLAYER_FIELD_CURRENCY_TOKEN_SLOT_1        = UNIT_END + 0x019C, // Size: 64, Type: LONG, Flags: PRIVATE
    ...
    PLAYER_FIELD_KNOWN_TITLES_1               = UNIT_END + 0x01E0, // Size: 2, Type: LONG, Flags: PRIVATE
    PLAYER_FIELD_KNOWN_TITLES_2               = UNIT_END + 0x01E2, // Size: 2, Type: LONG, Flags: PRIVATE
    ...
    PLAYER_CHARACTER_POINTS_1                 = UNIT_END + 0x0368, // Size: 1, Type: INT, Flags: PRIVATE
    PLAYER_CHARACTER_POINTS_2                 = UNIT_END + 0x0369, // Size: 1, Type: INT, Flags: PRIVATE
