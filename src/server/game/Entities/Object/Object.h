...
enum TypeMask
{
    TYPE_MASK_OBJECT         = 0x0001,
    TYPE_MASK_ITEM           = 0x0002,
    TYPE_MASK_CONTAINER      = 0x0006,                       // TYPEMASK_ITEM | 0x0004
    TYPE_MASK_UNIT           = 0x0008, // creature
    TYPE_MASK_PLAYER         = 0x0010,
    TYPE_MASK_GAMEOBJECT     = 0x0020,
    TYPE_MASK_DYNAMIC_OBJECT = 0x0040,
    TYPE_MASK_CORPSE         = 0x0080,
    TYPE_MASK_SEER           = TYPE_MASK_UNIT | TYPE_MASK_DYNAMIC_OBJECT
};
...
enum TypeID
{
    ...
    TYPE_ID_UNIT           = 3,
    TYPE_ID_PLAYER         = 4,
    TYPE_ID_GAMEOBJECT     = 5,
    TYPE_ID_DYNAMIC_OBJECT = 6,
    TYPE_ID_CORPSE         = 7
};
...
class Object
{
    public:
		...
		Player* ToPlayer() { if (GetTypeId() == TYPE_ID_PLAYER) return reinterpret_cast<Player*>(this); else return NULL; }
		Player const* ToPlayer() const { if (GetTypeId() == TYPE_ID_PLAYER) return (Player const*)((Player*)this); else return NULL; }
		Creature* ToCreature() { if (GetTypeId() == TYPE_ID_UNIT) return reinterpret_cast<Creature*>(this); else return NULL; }
		Creature const* ToCreature() const { if (GetTypeId() == TYPE_ID_UNIT) return (Creature const*)((Creature*)this); else return NULL; }

		Unit* ToUnit() { if (GetTypeId() == TYPE_ID_UNIT || GetTypeId() == TYPE_ID_PLAYER) return reinterpret_cast<Unit*>(this); else return NULL; }
		Unit const* ToUnit() const { if (GetTypeId() == TYPE_ID_UNIT || GetTypeId() == TYPE_ID_PLAYER) return (const Unit*)((Unit*)this); else return NULL; }
		GameObject* ToGameObject() { if (GetTypeId() == TYPE_ID_GAMEOBJECT) return reinterpret_cast<GameObject*>(this); else return NULL; }
		GameObject const* ToGameObject() const { if (GetTypeId() == TYPE_ID_GAMEOBJECT) return (const GameObject*)((GameObject*)this); else return NULL; }

		Corpse* ToCorpse() { if (GetTypeId() == TYPE_ID_CORPSE) return reinterpret_cast<Corpse*>(this); else return NULL; }
		Corpse const* ToCorpse() const { if (GetTypeId() == TYPE_ID_CORPSE) return (const Corpse*)((Corpse*)this); else return NULL; }
    protected:
...
class WorldObject : public Object, public WorldLocation
{
    ...
    public:
        ...
        virtual uint8 GetCurrentLevelForTarget(WorldObject const* /*target*/) const { return 1; }
        ...
        Creature* FindCreatureWithDistance(uint32 entry, float range, bool alive = true) const;
        GameObject* FindGameobjectWithDistance(uint32 entry, float range) const;
		GameObject* FindNearestGameObjectOfType(GameobjectTypes type, float range) const;

        Player* FindPlayerWithDistance(float range, bool alive = true) const;
