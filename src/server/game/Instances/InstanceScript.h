...
#ifndef QUANTUMCORE_INSTANCE_DATA_H
#define QUANTUMCORE_INSTANCE_DATA_H
...
#define OUT_SAVE_INST_DATA          sLog->outDebug(LOG_FILTER_QCSCR, "QUANTUMCORE SCRIPTS: Saving Instance Data for Instance %s (Map %d, Instance Id %d)", instance->GetMapName(), instance->GetId(), instance->GetInstanceId())
#define OUT_SAVE_INST_DATA_COMPLETE sLog->outDebug(LOG_FILTER_QCSCR, "QUANTUMCORE SCRIPTS: Saving Instance Data for Instance %s (Map %d, Instance Id %d) completed.", instance->GetMapName(), instance->GetId(), instance->GetInstanceId())
#define OUT_LOAD_INST_DATA(a)       sLog->outDebug(LOG_FILTER_QCSCR, "QUANTUMCORE SCRIPTS: Loading Instance Data for Instance %s (Map %d, Instance Id %d). Input is '%s'", instance->GetMapName(), instance->GetId(), instance->GetInstanceId(), a)
#define OUT_LOAD_INST_DATA_COMPLETE sLog->outDebug(LOG_FILTER_QCSCR, "QUANTUMCORE SCRIPTS: Instance Data Load for Instance %s (Map %d, Instance Id: %d) is complete.", instance->GetMapName(), instance->GetId(), instance->GetInstanceId())
#define OUT_LOAD_INST_DATA_FAIL     sLog->OutErrorConsole("QUANTUMCORE SCRIPTS: Unable to load Instance Data for Instance %s (Map %d, Instance Id: %d).", instance->GetMapName(), instance->GetId(), instance->GetInstanceId())
...
class InstanceScript : public ZoneScript
{
    public:
        ...
        DECLSPEC_DEPRECATED void DoCompleteAchievement(uint32 achievement_id) ATTR_DEPRECATED;
