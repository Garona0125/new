...
void WorldSession::HandleGuildQueryOpcode(WorldPacket& recvPacket)
{
    ...
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_QUERY [%s]: Guild: %u", guildId);
    if (!guildId)
        return;
...
void WorldSession::HandleGuildInviteOpcode(WorldPacket& recvPacket)
{
    ...
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_INVITE [%s]: Invited: %s", invitedName.c_str());
...
void WorldSession::HandleGuildRemoveOpcode(WorldPacket& recvPacket)
{
    ...
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_REMOVE [%s]: Target: %s", playerName.c_str());
...
{
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_ACCEPT [%s]", GetPlayer()->GetName());
...
{
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_DECLINE [%s]");
...
{
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_INFO [%s]");
...
{
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_ROSTER [%s]");
...
void WorldSession::HandleGuildPromoteOpcode(WorldPacket& recvPacket)
{
    ...
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_PROMOTE [%s]: Target: %s", playerName.c_str());
...
void WorldSession::HandleGuildDemoteOpcode(WorldPacket& recvPacket)
{
    ...
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_DEMOTE [%s]: Target: %s", playerName.c_str());
...
{
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_LEAVE [%s]");
...
{
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_DISBAND [%s]");
...
void WorldSession::HandleGuildLeaderOpcode(WorldPacket& recvPacket)
{
    ...
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_LEADER [%s]: Target: %s", name.c_str());
...
void WorldSession::HandleGuildMOTDOpcode(WorldPacket& recvPacket)
{
    ...
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_MOTD [%s]: MOTD: %s", motd.c_str());
...
void WorldSession::HandleGuildSetPublicNoteOpcode(WorldPacket& recvPacket)
{
    ...
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_SET_PUBLIC_NOTE [%s]: Target: %s, Note: %s", playerName.c_str(), note.c_str());
...
void WorldSession::HandleGuildSetOfficerNoteOpcode(WorldPacket& recvPacket)
{
    ...
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_SET_OFFICER_NOTE [%s]: Target: %s, Note: %s", playerName.c_str(), note.c_str());
...
void WorldSession::HandleGuildRankOpcode(WorldPacket& recvPacket)
{
    ...
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_RANK [%s]: Rank: %s (%u)", rankName.c_str(), rankId);
...
void WorldSession::HandleGuildAddRankOpcode(WorldPacket& recvPacket)
{
    ...
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_ADD_RANK [%s]: Rank: %s", rankName.c_str());
...
{
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_DEL_RANK [%s]");
...
void WorldSession::HandleGuildChangeInfoTextOpcode(WorldPacket& recvPacket)
{
    ...
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_INFO_TEXT [%s]: %s", info.c_str());
...
void WorldSession::HandleSaveGuildEmblemOpcode(WorldPacket& recvPacket)
{
    ...
    sLog->outDebug(LOG_FILTER_GUILD, "MSG_SAVE_GUILD_EMBLEM [%s]: Guid: [" UI64FMTD
        ...
        , vendorGuid, emblemInfo.GetStyle()
        , emblemInfo.GetColor(), emblemInfo.GetBorderStyle()
        , emblemInfo.GetBorderColor(), emblemInfo.GetBackgroundColor());

    if (GetPlayer()->GetNPCIfCanInteractWith(vendorGuid, UNIT_NPC_FLAG_TABARD_DESIGNER))
    {
        // Remove fake death
...
{
    sLog->outDebug(LOG_FILTER_GUILD, "MSG_GUILD_BANK_MONEY_WITHDRAWN [%s]");
...
{
    sLog->outDebug(LOG_FILTER_GUILD, "MSG_GUILD_PERMISSIONS [%s]");
...
void WorldSession::HandleGuildBankDepositMoney(WorldPacket& recvData)
{
    ...
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_BANK_DEPOSIT_MONEY [%s]: Go: [" UI64FMTD "], money: %u", guid, money);
...
void WorldSession::HandleGuildBankWithdrawMoney(WorldPacket& recvData)
{
    ...
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_BANK_WITHDRAW_MONEY [%s]: Go: [" UI64FMTD "], money: %u", guid, money);
...
{
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_BANK_SWAP_ITEMS [%s]");
...
void WorldSession::HandleGuildBankBuyTab(WorldPacket& recvData)
{
    ...
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_BANK_BUY_TAB [%s]: Go: [" UI64FMTD "], TabId: %u", guid, tabId);
...
void WorldSession::HandleGuildBankUpdateTab(WorldPacket& recvData)
{
    ...
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_GUILD_BANK_UPDATE_TAB [%s]: Go: [" UI64FMTD "], TabId: %u, Name: %s, Icon: %s"
        , guid, tabId, name.c_str(), icon.c_str());
...
void WorldSession::HandleGuildBankLogQuery(WorldPacket& recvData)
{
    ...
    sLog->outDebug(LOG_FILTER_GUILD, "MSG_GUILD_BANK_LOG_QUERY [%s]: TabId: %u", tabId);
...
void WorldSession::HandleQueryGuildBankTabText(WorldPacket &recvData)
{
    ...
    sLog->outDebug(LOG_FILTER_GUILD, "MSG_QUERY_GUILD_BANK_TEXT [%s]: TabId: %u", tabId);
...
void WorldSession::HandleSetGuildBankTabText(WorldPacket &recvData)
{
    ...
    sLog->outDebug(LOG_FILTER_GUILD, "CMSG_SET_GUILD_BANK_TEXT [%s]: TabId: %u, Text: %s", tabId, text.c_str());
