...
{                                                           // value1           value2         value3
    ...
    CONDITION_TITLE                 = 21,                   // title id         0              0                  true if player has title
    ...
    CONDITION_TYPE_MASK             = 32,                   // Type Mask        0              0                  true if object is type object's Type Mask matches provided Type Mask
