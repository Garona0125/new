...
void DoSendQuantumText(int32 textEntry, WorldObject* pSource, Unit* target = NULL);
...
template<class TMap> class MapScript : public UpdatableScript<TMap>
{
    ...
    protected:
        ...
        {
            if (!_mapEntry)
                sLog->OutErrorConsole("Invalid MapScript for %u; no such map ID.", mapId);
        }
...
class PlayerScript : public ScriptObject
{
    ...
    public:
		...
		// Called when a player kill in battleground.
		virtual void OnPlayerFirstKillBattleground(Player* /*player*/, Battleground* /*bg*/) { }

		// Called when a player time update in.
		virtual void OnUpdateTimer(Player* /*player*/, uint32 /*diff*/) { }
};
...
class ScriptMgr
{
    ...
    public: /* Initialization */
        ...
        const char* ScriptsVersion() const { return "Integrated Quantum Scripts"; }
