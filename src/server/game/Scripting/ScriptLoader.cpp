...
void AddSC_boss_chrono_lord_epoch();       //CoT Culling Of Stratholme
...
void AddSC_boss_ayamiss_the_hunter();        //Ruins of ahn'qiraj
void AddSC_boss_buru_the_gorger();
void AddSC_boss_general_rajaxx();
void AddSC_boss_kurinnaxx();
void AddSC_boss_moam();
void AddSC_boss_ossirian_the_unscarred();
void AddSC_instance_ruins_of_ahnqiraj();
void AddSC_bug_trio();                      // Temple of ahn'qiraj
...
void AddSC_ashenvale();                     //Locations
void AddSC_azshara();
...
void AddSC_boss_krik_thir_the_gatewatcher(); //Azjol-Nerub
...
void AddSC_boss_gothik_the_harvester();
...
void AddSC_boss_gortok_palehoof();      // Utgarde Pinnacle
void AddSC_boss_king_ymiron();
void AddSC_boss_skadi_the_ruthless();
void AddSC_boss_svala_sorrowgrave();
void AddSC_instance_utgarde_pinnacle();
void AddSC_utgarde_keep();
void AddSC_boss_archavon_the_stone_watcher(); // Vault of Archavon
...
void AddSC_boss_king_dred();            // Drak'Tharon Keep
...
void AddSC_boss_blood_guard_porung();         // HC Shattered Halls
...
// Outdoor PVP
void AddSC_outdoor_pvp_ep();
void AddSC_outdoor_pvp_hp();
void AddSC_outdoor_pvp_na();
void AddSC_outdoor_pvp_si();
void AddSC_outdoor_pvp_tf();
void AddSC_outdoor_pvp_zm();
void AddSC_outdoor_pvp_gh();
...
void AddCommandScripts()
{
	...
	AddSC_wintergrasp_commandscript();
...
void AddKalimdorScripts()
{
	...
	AddSC_boss_chrono_lord_epoch();       //CoT Culling Of Stratholme
	AddSC_boss_infinite_corruptor();
	AddSC_boss_mal_ganis();
	AddSC_boss_meathook();
	AddSC_boss_salramm_the_fleshcrafter();
	...
	AddSC_boss_ayamiss_the_hunter();        //Ruins of ahn'qiraj
	AddSC_boss_buru_the_gorger();
	AddSC_boss_general_rajaxx();
	AddSC_boss_kurinnaxx();
	AddSC_boss_moam();
	AddSC_boss_ossirian_the_unscarred();
	AddSC_instance_ruins_of_ahnqiraj();
	AddSC_bug_trio();                       //Temple of ahn'qiraj
    AddSC_boss_cthun();
	AddSC_boss_viscidus();
    AddSC_boss_fankriss_the_unyielding();
    AddSC_boss_princess_huhuran();
    AddSC_boss_battleguard_sartura();
    AddSC_boss_prophet_skeram();
    AddSC_boss_twin_emperors();
	AddSC_boss_ouro();
...
void AddOutlandScripts()
{
	...
	AddSC_boss_blood_guard_porung();        //HC Shattered Halls
...
void AddNorthrendScripts()
{
	...
	AddSC_boss_krik_thir_the_gatewatcher(); //Azjol-Nerub
    AddSC_boss_hadronox();
    ...
    AddSC_boss_instructor_razuvious();
    AddSC_boss_kelthuzad();
    AddSC_boss_loatheb();
    AddSC_boss_noth_the_plaguebringer();
    AddSC_boss_gluth();
    AddSC_boss_sapphiron();
    AddSC_boss_four_horsemen();
    AddSC_boss_grand_widow_faerlina();
    AddSC_boss_heigan_the_unclean();
    AddSC_boss_gothik_the_harvester();
    AddSC_boss_thaddius();
    AddSC_instance_naxxramas();
	AddSC_naxxramas_teleporter();
    ...
    AddSC_boss_ignis_the_furnace_master();
    AddSC_boss_razorscale();
    AddSC_boss_xt_002_deconstructor();
	...
	AddSC_boss_gortok_palehoof();      // Utgarde Pinnacle
	AddSC_boss_king_ymiron();
	AddSC_boss_skadi_the_ruthless();
	AddSC_boss_svala_sorrowgrave();
	AddSC_instance_utgarde_pinnacle();
    AddSC_utgarde_keep();
	AddSC_boss_archavon_the_stone_watcher(); // Vault of Archavon
	AddSC_boss_emalon_the_storm_watcher();
	AddSC_boss_koralon_the_flame_watcher();
	AddSC_boss_toravon_the_ice_watcher();
	AddSC_instance_vault_of_archavon();
    AddSC_boss_trollgore();             //Drak'Tharon Keep
    AddSC_boss_novos_the_summoner();
    AddSC_boss_king_dred();
    AddSC_boss_prophet_tharon_ja();
...
{
#ifdef SCRIPTS
    AddSC_outdoor_pvp_ep();
    AddSC_outdoor_pvp_hp();
    AddSC_outdoor_pvp_na();
    AddSC_outdoor_pvp_si();
    AddSC_outdoor_pvp_tf();
    AddSC_outdoor_pvp_zm();
	AddSC_outdoor_pvp_gh();
    AddSC_outdoor_pvp_wg();
#endif
}
...
{
#ifdef SCRIPTS
	AddSC_mod_account_history();
	AddSC_mod_arena_watcher();
	AddSC_mod_character_model();
	AddSC_npc_enchancement_master();
	AddSC_npc_profession_master();
	AddSC_npc_vip_vendor();
#endif
}

void AddQuantumCoreScripts()
{
#ifdef SCRIPTS
	// Wotlk
	AddSC_ahnkahet_the_old_kingdom_trash();
	AddSC_azjol_nerub_trash();
	AddSC_culling_of_stratholme_trash();
	AddSC_drak_tharon_keep_trash();
	AddSC_forge_of_souls_trash();
	AddSC_gundrak_trash();
	AddSC_halls_of_lightning_trash();
	AddSC_halls_of_reflection_trash();
	AddSC_halls_of_stone_trash();
	AddSC_icecrown_citadel_trash();
	AddSC_naxxramas_trash();
	AddSC_nexus_trash();
	AddSC_obsidian_sanctum_trash();
	AddSC_oculus_trash();
	AddSC_pit_of_saron_trash();
	AddSC_ruby_sanctum_trash();
	AddSC_ulduar_trash();
	AddSC_utgarde_keep_trash();
	AddSC_utgarde_pinnacle_trash();
	// Burning Crusade
	AddSC_arcatraz_trash();
	AddSC_auchenai_crypts_trash();
	AddSC_black_temple_trash();
	AddSC_blood_furnace_trash();
	AddSC_botanica_trash();
	AddSC_coilfang_reservoir_trash();
	AddSC_hellfire_ramparts_trash();
	AddSC_karazhan_trash();
	AddSC_magisters_terrace_trash();
	AddSC_mana_tombs_trash();
	AddSC_mechanar_trash();
	AddSC_sethekk_halls_trash();
	AddSC_shadow_labyrinth_trash();
	AddSC_shattered_halls_trash();
	AddSC_slave_pens_trash();
	AddSC_steam_vault_trash();
	AddSC_sunwel_plateau_trash();
	AddSC_tempest_keep_the_eye_trash();
	AddSC_underbog_trash();
	// Classic
	AddSC_blackwing_lair_trash();
	AddSC_molten_core_trash();
	AddSC_ruins_of_ahnqiraj_trash();
	AddSC_temple_of_ahnqiraj_trash();
	// World System Scripts
	AddSC_world_achievement_system();
	AddSC_world_anniversary_system();
	AddSC_world_anti_advertising_system();
	AddSC_world_auto_learn_spell_system();
	AddSC_world_battleground_kill_system();
	AddSC_world_chat_filter_system();
	AddSC_world_chat_icon_system();
	AddSC_world_duel_reset_cooldown_system();
	AddSC_world_fun_new_system();
	AddSC_world_fun_old_system();
	AddSC_world_game_master_monitoring_system();
	AddSC_world_game_master_system();
	AddSC_world_login_info_system();
	AddSC_world_raid_progress_system();
	AddSC_world_rewarding_system();
	AddSC_world_starting_player_system();
	AddSC_world_transmogrification_system();
	// World Custom Scripts
	AddSC_battle_tyrael();
	AddSC_funny_panda_of_shaolin();
	AddSC_insidious_cat();
	AddSC_server_helper();
	// World Sripts
	AddSC_alliance_and_horde_bosses();
	AddSC_alliance_and_horde_guards();
	AddSC_world_event_scripts();
	AddSC_world_guard_scripts();
	AddSC_world_quest_scripts();
	AddSC_world_rare_elite_scripts();
	AddSC_world_season_events();
	// World Zone Scripts
	AddSC_eastern_kingdoms_npc_scripts();
	AddSC_kalimdor_npc_scripts();
	AddSC_northrend_npc_scripts();
	AddSC_outland_npc_scripts();
#endif
}